...
#define CM_GetCurrentDiagnosticMode(m) (*(m)=NEXTEER_SESSION)
...
#define CM_CyberSecNexteerLocked_Cnt_lgc ((boolean)(DescGetStateSecurity_Access() != kDescStateSecurity_AccessNexteer_Unlock))
