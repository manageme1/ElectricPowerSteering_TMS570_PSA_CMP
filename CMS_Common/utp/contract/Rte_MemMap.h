...
#   error "The magic number of the generated file <C:/ccm_wa/CBD/VehSpdLmt/utp/contract/Ap_VehSpdLmt/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
