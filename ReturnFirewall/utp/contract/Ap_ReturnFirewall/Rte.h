...
#    error "The magic number of the generated file <C:/Synergy_projects/ReturnFirewall-lz4p8n/ReturnFirewall/utp/contract/Ap_ReturnFirewall/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
