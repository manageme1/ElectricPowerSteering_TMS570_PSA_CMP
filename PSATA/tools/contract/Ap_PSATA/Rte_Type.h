...
struct Rte_CDS_Ap_PSATA
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_ApaOpTrqOv_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_ApaPosSrvoFlt_Cnt_lgc;
  P2VAR(Rte_DE_PsaApaSt_Cnt_enum, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_ApaState_Cnt_enum;
  P2VAR(Rte_DE_PsaEpsStLxa_Cnt_enum, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_EPSStateForLxa_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_HandwheelVelocity_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_HwTrqRate_HwNmpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_LxaCorrnFacReqLimd_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_LxaDrvrAbsntHwVelDetd_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_LxaHwAgDetd_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_LxaOpTrqOv_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_LxaTqLimnActv_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_OpTrqOv_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_PosSrvoCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_PosSrvoEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSATA_APPL_VAR) PSATA_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_PSATA, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PSATA;
...
#    error "The magic number of the generated file <C:/Users/nz2999/Documents/Synergy/ccm_wa/ses_dev_ea3/PSATA-nz2999/PSATA/tools/contract/Ap_PSATA/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
