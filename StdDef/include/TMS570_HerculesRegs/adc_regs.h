...
typedef volatile struct adcctrlregs
{
    ...
    uint32 GxSR[3U];           /**< 0x006C-0x0074: Group 0-2 status register                  */ /* Nexteer change to define G0SR, G1SR, and G2SR as an array for Adc driver design efficiency */
