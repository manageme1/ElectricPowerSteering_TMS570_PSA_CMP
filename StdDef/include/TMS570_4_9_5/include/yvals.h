...
/* targets with "native" mode libraries don't support C9X */
  ...
  #if !defined(_C99_MATH)
    #define _C99_MATH 1
  #endif

  #if defined(__TI_VFPLIB_SUPPORT__)
    #if defined(__TI_FPV4SPD16_SUPPORT__)
      #define _HAS_C9X_FAST_FMAF 1
    #else
      #define _HAS_C9X_FAST_FMA 1
    #endif
  #endif
      ...
      #if defined(__TI_VFPLIB_SUPPORT__)
          #define _D0   3       /* Most significant word's offset is 3 */
      #elif defined(__TI_FPALIB_SUPPORT__)
          #define _D0   1       /* Most significant word's offset is 1 */
      #endif
   #endif
  #define _DLONG	0	/* 0: 64, 1: 80, 2: 128 long double bits */
  #define _LBIAS	0x3fe	/* 64 long double bits */
...
#define _MEMBND	3U /* eight-byte boundaries (2^^3) */
		...
		/* time PROPERTIES */
  #if _AEABI_PORTABILITY_CHECK
    #define _CPS (__aeabi_CLOCKS_PER_SEC)
  #else
    #define _CPS    1000
  #endif /* _AEABI_PORTABILITY_CHECK */
  #define _TBIAS	0
