...
extern _DATA_ACCESS fenv_t _TLS_QUAL _Fenv;
 #endif /* _FPP_TYPE */
...
/* THE TI COMPILER ONLY SUPPORTS THE FE_TONEAREST ROUNDING MODE */
static __inline int fegetround(void)    { return FE_TONEAREST; }
static __inline int fesetround(int _rm) { return _rm == FE_TONEAREST ? 0 : 1; }
...
double _Force_raise(int except);
		...
		/* OBJECT DECLARATIONS */
extern /* const */ _DATA_ACCESS fenv_t _Fenv0;
_END_C_LIB_DECL
_C_STD_END
#endif /* _FENV */
