...
# define EnergyModeStateType_LowerLimit ((EnergyModeStateType)0u)
# define EnergyModeStateType_UpperLimit ((EnergyModeStateType)3u)
...
#  define NORMAL ((EnergyModeStateType)0u)
# endif
...
#  define PRODUCTION ((EnergyModeStateType)1u)
# endif
...
#  define TRANSPORTATION ((EnergyModeStateType)2u)
# endif
...
#  define FLASH ((EnergyModeStateType)3u)
# endif
...
struct Rte_CDS_Sa_DigMSB
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Init_TurnsCounterSelected_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_AlignedCumMechMtrPosCRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_AlignedCumMechMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_AlignedCumMechMtrPosStatus_Cnt_u08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_AssistAssemblyPolarity_Cnt_s08;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_CorrectedElecMtrPos_Rev_u0p16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_CumMechMtrPosCRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_CumMechMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_CumMechMtrPosStatus_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_CumMechMtrPos_Rev_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_Die1RxError_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_Die1RxMtrPos_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_Die1RxRevCtr_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_Die1UnderVoltgFltAccum_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_Die2RxError_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_Die2RxMtrPos_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_Die2RxRevCtr_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_MechMtrPos2_Rev_u0p16;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_MtrPosPolarity_Cnt_s08;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_RxMtrPosParityAccum_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_SysCCumMechMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per2_UncorrMechMtrPos1_Rev_u0p16;
  P2VAR(Rte_DE_EnergyModeStateType, TYPEDEF, RTE_SA_DIGMSB_APPL_VAR) DigMSB_Per3_EnergyModeState_Cnt_enum;
  /* PIM Handles section */
  P2VAR(DigMSBEOLType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_DigMSBEOLData;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_DigMSB, RTE_CONST, RTE_CONST) Rte_Inst_Sa_DigMSB;
...
#    error "The magic number of the generated file <C:/Users/nz2999/Documents/Synergy/ccm_wa/ses_dev_ea3/DigMSB-nz2999/DigMSB/utp/contract/Sa_DigMSB/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
