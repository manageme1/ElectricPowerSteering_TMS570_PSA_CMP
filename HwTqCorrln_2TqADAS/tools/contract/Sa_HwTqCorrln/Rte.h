...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/HwTqCorrln_2TqADAS/tools/contract/Sa_HwTqCorrln/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
