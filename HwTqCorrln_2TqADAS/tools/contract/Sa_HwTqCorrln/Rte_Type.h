...
struct Rte_CDS_Sa_HwTqCorrln
{
  /* Data Handles section */
  P2VAR(Rte_DE_SigQlfr_State_enum, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per1_HwTq1Qlfr_State_enum;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per1_HwTq1RollgCntr_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per1_HwTq1Val_HwNm_f32;
  P2VAR(Rte_DE_SigQlfr_State_enum, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per1_HwTq2Qlfr_State_enum;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per1_HwTq2RollgCntr_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per1_HwTq2Val_HwNm_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per1_HwTqCorrlnSts_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per2_HwTq1Val_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per2_HwTq2Val_HwNm_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per2_HwTqIdptSig_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTQCORRLN_APPL_VAR) HwTqCorrln_Per3_HwTqVal_HwNm_f32;
  /* PIM Handles section */
  P2VAR(Float, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_HwTqCorrlnCh1CMCLPFSvData;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_HwTqCorrln, RTE_CONST, RTE_CONST) Rte_Inst_Sa_HwTqCorrln;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/HwTqCorrln_2TqADAS/tools/contract/Sa_HwTqCorrln/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
