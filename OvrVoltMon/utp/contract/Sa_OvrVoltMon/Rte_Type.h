...
struct Rte_CDS_Sa_OvrVoltMon
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_OVRVOLTMON_APPL_VAR) OvrVoltMon_Per1_PwrDiscBTestStart_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_OvrVoltMon, RTE_CONST, RTE_CONST) Rte_Inst_Sa_OvrVoltMon;
...
#    error "The magic number of the generated file <C:/Users/nzt9hv/Documents/Synergy/ccm_wa/ESG_Dev_65/OvrVoltMon-nzt9hv/OvrVoltMon/utp/contract/Sa_OvrVoltMon/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
