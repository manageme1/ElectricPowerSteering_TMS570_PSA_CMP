...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!     << Start of compiler abstraction implementation >>       DO NOT CHANGE THIS COMMENT!
 * Symbol: RTE_AP_DIAGMGR_APPL
 *********************************************************************************************************************/

/* used for references on application variables */
# define RTE_AP_DIAGMGR_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_DIAGMGR_APPL_DATA

/* used for references on application functions */
# define RTE_AP_DIAGMGR_APPL_CODE
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/DiagMgr/utp/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
