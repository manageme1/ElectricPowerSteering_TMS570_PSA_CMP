...
#    error "The magic number of the generated file <C:/Workspace/BVDiag-CBD_BVDiag/SER/BVDiag/utp/contract/Ap_BVDiag/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
