...
struct Rte_CDS_Ap_BVDiag
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BVDIAG_APPL_VAR) BVDiag_Per1_Batt_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_BVDIAG_APPL_VAR) BVDiag_Per1_CCLMSAActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_BVDIAG_APPL_VAR) BVDiag_Per1_NTCB1Enbl_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_BVDiag, RTE_CONST, RTE_CONST) Rte_Inst_Ap_BVDiag;
...
#    error "The magic number of the generated file <C:/Workspace/BVDiag-CBD_BVDiag/SER/BVDiag/utp/contract/Ap_BVDiag/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
