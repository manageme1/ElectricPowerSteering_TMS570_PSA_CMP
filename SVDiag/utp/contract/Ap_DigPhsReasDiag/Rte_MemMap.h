...
#   error "The magic number of the generated file <C:/Rijvi_Synergy/Core_Component/Working/SVDiag-jzk9cc/SVDiag/utp/contract/Ap_DigPhsReasDiag/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
