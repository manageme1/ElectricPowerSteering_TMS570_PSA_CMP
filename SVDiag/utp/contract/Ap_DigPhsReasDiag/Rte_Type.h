...
#  define FETFAULTTYPE_ENUM_LowerLimit ((FETFAULTTYPE_ENUM)0u)
#  define FETFAULTTYPE_ENUM_UpperLimit ((FETFAULTTYPE_ENUM)255u)
...
#   define NOFAULT ((FETFAULTTYPE_ENUM)0u)
#  endif
...
#   define LOWER ((FETFAULTTYPE_ENUM)1u)
#  endif
...
#   define UPPER ((FETFAULTTYPE_ENUM)2u)
#  endif

#  define Rte_TypeDef_FETPHASETYPE_ENUM
typedef uint8 FETPHASETYPE_ENUM;
#  define FETPHASETYPE_ENUM_LowerLimit ((FETPHASETYPE_ENUM)0u)
#  define FETPHASETYPE_ENUM_UpperLimit ((FETPHASETYPE_ENUM)255u)
...
#   define NOPHASE ((FETPHASETYPE_ENUM)0u)
#  endif
...
#   define PHASEA ((FETPHASETYPE_ENUM)1u)
#  endif
...
#   define PHASEB ((FETPHASETYPE_ENUM)2u)
#  endif
...
#   define PHASEC ((FETPHASETYPE_ENUM)3u)
#  endif
...
struct Rte_CDS_Ap_DigPhsReasDiag
{
  /* Data Handles section */
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_ExpectedOnTimeA_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_ExpectedOnTimeB_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_ExpectedOnTimeC_Cnt_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_GateDriveResetActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_LRPRCorrectedMtrPosCaptured_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_LRPRModulationIndexCaptured_Uls_f32;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_LRPRPhaseadvanceCaptured_Cnt_s16;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_MeasuredOnTimeA_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_MeasuredOnTimeB_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_MeasuredOnTimeC_Cnt_u32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_MotorVelMRFUnfiltered_MtrRadpS_f32;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_MtrElecMechPolarity_Cnt_s08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_DIGPHSREASDIAG_APPL_VAR) DigPhsReasDiag_Per1_PDActivateTest_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_DigPhsReasDiag, RTE_CONST, RTE_CONST) Rte_Inst_Ap_DigPhsReasDiag;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy/Core_Component/Working/SVDiag-jzk9cc/SVDiag/utp/contract/Ap_DigPhsReasDiag/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
