...
struct Rte_CDS_Sa_MtrDrvDiag
{
  /* Data Handles section */
  P2VAR(Rte_DE_FETPHASETYPE_ENUM, TYPEDEF, RTE_SA_MTRDRVDIAG_APPL_VAR) MtrDrvDiag_Per1_FETFaultPhase_Cnt_enum;
  P2VAR(Rte_DE_FETFAULTTYPE_ENUM, TYPEDEF, RTE_SA_MTRDRVDIAG_APPL_VAR) MtrDrvDiag_Per1_FETFaultType_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_MTRDRVDIAG_APPL_VAR) MtrDrvDiag_Per1_GateDriveResetActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_MTRDRVDIAG_APPL_VAR) MtrDrvDiag_Per1_MtrDrvrInitComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_MTRDRVDIAG_APPL_VAR) MtrDrvDiag_Per1_MtrDrvrInitStart_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_MTRDRVDIAG_APPL_VAR) MtrDrvDiag_Trns1_MtrDrvrInitComplete_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_MtrDrvDiag, RTE_CONST, RTE_CONST) Rte_Inst_Sa_MtrDrvDiag;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy/Core_Component/Working/SVDiag-jzk9cc/SVDiag/utp/contract/Sa_MtrDrvDiag/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
