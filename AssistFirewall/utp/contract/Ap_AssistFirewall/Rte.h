...
#    error "The magic number of the generated file <C:/Synergy_projects/AssistFirewall-lz4p8n/AssistFirewall/utp/contract/Ap_AssistFirewall/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
