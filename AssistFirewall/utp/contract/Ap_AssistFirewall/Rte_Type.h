...
struct Rte_CDS_Ap_AssistFirewall
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_AsstFirewallActive_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_BaseAssistCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_CombinedAssist_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_Defeat_AsstTbl_Service_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_HighFreqAssist_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_HysteresisComp_MtrNm_f32;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_MEC_Counter_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTFIREWALL_APPL_VAR) AssistFirewall_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_AssistFirewall, RTE_CONST, RTE_CONST) Rte_Inst_Ap_AssistFirewall;
...
#    error "The magic number of the generated file <C:/Synergy_projects/AssistFirewall-lz4p8n/AssistFirewall/utp/contract/Ap_AssistFirewall/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
