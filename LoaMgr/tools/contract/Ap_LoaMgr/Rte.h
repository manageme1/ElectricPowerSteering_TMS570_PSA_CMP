...
#    error "The magic number of the generated file <C:/_Synergy_Projects/EA3_Working/LoaMgr/tools/contract/Ap_LoaMgr/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
