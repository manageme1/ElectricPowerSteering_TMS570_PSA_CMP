...
# define LOA_State_enum_LowerLimit ((LOA_State_enum)0u)
# define LOA_State_enum_UpperLimit ((LOA_State_enum)5u)
...
#  define LOAST_NORM ((LOA_State_enum)0u)
# endif
...
#  define LOAST_REDCD ((LOA_State_enum)1u)
# endif
...
#  define LOAST_SWBASDMTGTN ((LOA_State_enum)2u)
# endif
...
#  define LOAST_FADEOUT ((LOA_State_enum)3u)
# endif
...
#  define LOAST_CTRLDSHTDWNREQD ((LOA_State_enum)4u)
# endif
...
#  define LOAST_RPDSHTDWNREQD ((LOA_State_enum)5u)
# endif
...
# define SteerMod_enum_LowerLimit ((SteerMod_enum)0u)
# define SteerMod_enum_UpperLimit ((SteerMod_enum)2u)
...
#  define STEERMOD_BASEPS ((SteerMod_enum)0u)
# endif
...
#  define STEERMOD_SEMIATNMS ((SteerMod_enum)1u)
# endif
...
#  define STEERMOD_FULLYATNMS ((SteerMod_enum)2u)
# endif
...
#  define D_LOASTATEINIT_CNT_ENUM ((LOA_State_enum)0u)
# endif
...
#  define D_STEERMODINIT_CNT_ENUM ((SteerMod_enum)0u)
# endif
...
#  define D_FOUR_CNT_U08 ((UInt8)4u)
# endif
...
#  define D_THREE_CNT_U08 ((UInt8)3u)
# endif
...
struct Rte_CDS_Ap_LoaMgr
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_DiagcStsIvtr1Inactv_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_DiagcStsIvtr2Inactv_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_HwTqIdptSig_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_HwTqLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_IvtrLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_LOA_State_enum, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_LOASt_State_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_LoaScaDi_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_MotAgLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_MotCurrIdptSig_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_MotCurrLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_MtrPosIdptSig_Cnt_u08;
  P2VAR(Rte_DE_SteerMod_enum, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_SteerMod_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_TloaAvail_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LOAMGR_APPL_VAR) LoaMgr_Per1_TloaDi_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_LoaMgr, RTE_CONST, RTE_CONST) Rte_Inst_Ap_LoaMgr;
...
#    error "The magic number of the generated file <C:/_Synergy_Projects/EA3_Working/LoaMgr/tools/contract/Ap_LoaMgr/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
