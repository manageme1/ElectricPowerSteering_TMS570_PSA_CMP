...
# endif
# if (defined RTE_CONST_NTC_Num_PLLSlipRcvrl) || (defined NTC_Num_PLLSlipRcvrl)
#  if (!defined RTE_CONST_NTC_Num_PLLSlipRcvrl) || (RTE_CONST_NTC_Num_PLLSlipRcvrl != 21u)
#   error "Enumeration constant <NTC_Num_PLLSlipRcvrl> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_PLLSlipRcvrl (21u)
#  define NTC_Num_PLLSlipRcvrl ((NTCNumber)21u)
# endif
...
# endif
# if (defined RTE_CONST_NTC_Num_TurnCntr_DataFlt) || (defined NTC_Num_TurnCntr_DataFlt)
#  if (!defined RTE_CONST_NTC_Num_TurnCntr_DataFlt) || (RTE_CONST_NTC_Num_TurnCntr_DataFlt != 135u)
#   error "Enumeration constant <NTC_Num_TurnCntr_DataFlt> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_TurnCntr_DataFlt (135u)
#  define NTC_Num_TurnCntr_DataFlt ((NTCNumber)135u)
# endif
...
# define SigQlfr_State_enum_LowerLimit ((SigQlfr_State_enum)0u)
# define SigQlfr_State_enum_UpperLimit ((SigQlfr_State_enum)2u)
...
#  define SIGQLFR_NORES ((SigQlfr_State_enum)0u)
# endif
...
#  define SIGQLFR_PASS ((SigQlfr_State_enum)1u)
# endif
...
#  define SIGQLFR_FAIL ((SigQlfr_State_enum)2u)
# endif
...
#  define D_SIGQLFRNORES_CNT_ENUM ((SigQlfr_State_enum)0u)
# endif
...
#  define D_THREE_CNT_U16 ((UInt16)3u)
# endif
...
struct Rte_CDS_Sa_HwTqArbn
{
  /* Data Handles section */
  P2VAR(Rte_DE_SigQlfr_State_enum, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per1_HwTq1Qlfr_State_enum;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per1_HwTq1RollgCntr_Cnt_u08;
  P2VAR(Rte_DE_SigQlfr_State_enum, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per1_HwTq2Qlfr_State_enum;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per1_HwTq2RollgCntr_Cnt_u08;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per1_HwTqCorrlnSts_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per2_HwTq1Val_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per2_HwTq2Val_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per2_HwTqVal_HwNm_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per3_MEC_Counter_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_HWTQARBN_APPL_VAR) HwTqArbn_Per3_SVC_ClearCodes_Cnt_lgc;
  /* PIM Handles section */
  P2VAR(EOLChOffsetTrim_DataType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_HwTqArbnEOLCh1OffsetTrimData;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_HwTqArbn, RTE_CONST, RTE_CONST) Rte_Inst_Sa_HwTqArbn;
...
#    error "The magic number of the generated file <C:/Users/nz2378/Documents/work/CR_EA3_9800/Task_EA3_7839/SWC/HwTqArbn_2TqADAS/tools/contract/Sa_HwTqArbn/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
