...
#    error "The magic number of the generated file <C:/CM_Synergy/ccm_wa/Working/CBD/MtrTempEst/MtrTempEst/utp/contract/Ap_MtrTempEst/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
