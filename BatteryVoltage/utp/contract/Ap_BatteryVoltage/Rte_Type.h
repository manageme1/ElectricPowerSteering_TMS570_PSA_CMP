...
struct Rte_CDS_Ap_BatteryVoltage
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BATTERYVOLTAGE_APPL_VAR) BatteryVoltage_Per1_BattSwitched_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BATTERYVOLTAGE_APPL_VAR) BatteryVoltage_Per1_Batt_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BATTERYVOLTAGE_APPL_VAR) BatteryVoltage_Per1_SysC_Vecu_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BATTERYVOLTAGE_APPL_VAR) BatteryVoltage_Per1_Vecu_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_BATTERYVOLTAGE_APPL_VAR) BatteryVoltage_Per1_VswitchClosed_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BATTERYVOLTAGE_APPL_VAR) BatteryVoltage_Per2_BattSwitched_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BATTERYVOLTAGE_APPL_VAR) BatteryVoltage_Per2_SysCVSwitch_Volt_f32;
  /* PIM Handles section */
  P2VAR(OvervoltageDataType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_OvervoltageData;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_BatteryVoltage, RTE_CONST, RTE_CONST) Rte_Inst_Ap_BatteryVoltage;
...
#    error "The magic number of the generated file <C:/Workspace/BatteryVoltage-CBD_BatteryVoltage/FDD08B/BatteryVoltage/utp/contract/Ap_BatteryVoltage/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
