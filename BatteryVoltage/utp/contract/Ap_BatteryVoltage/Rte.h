...
#    error "The magic number of the generated file <C:/Workspace/BatteryVoltage-CBD_BatteryVoltage/FDD08B/BatteryVoltage/utp/contract/Ap_BatteryVoltage/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
