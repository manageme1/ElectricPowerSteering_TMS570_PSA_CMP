...
struct Rte_CDS_Ap_Sweep
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SWEEP_APPL_VAR) Sweep_Per1_InputHwTrq_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SWEEP_APPL_VAR) Sweep_Per1_OutputHwTrq_HwNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SWEEP_APPL_VAR) Sweep_Per1_VehSpdValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SWEEP_APPL_VAR) Sweep_Per1_VehSpd_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_Sweep, RTE_CONST, RTE_CONST) Rte_Inst_Ap_Sweep;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/Sweep-nzt9hv/Sweep/utp/contract/Ap_Sweep/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
