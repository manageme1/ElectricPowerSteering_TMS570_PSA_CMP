...
#   error "The magic number of the generated file <C:/_Synergy_Projects/Working/BkCpPc-nz63rn/BkCpPc/utp/contract/Sa_BkCpPc/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
