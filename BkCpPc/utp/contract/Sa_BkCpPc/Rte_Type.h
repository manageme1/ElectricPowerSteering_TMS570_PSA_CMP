...
struct Rte_CDS_Sa_BkCpPc
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_BattSwitched_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_Batt_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_MotorVelocityMRFUnfiltered_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_OVERRIDESIGDIAGADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_PMOSDIAGADC_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_PwrDiscATestComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_PwrDiscATestStart_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_PwrDiscBTestComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_PwrDiscBTestStart_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Per1_PwrDiscClosed_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Trns1_PwrDiscATestComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Trns1_PwrDiscBTestComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Trns2_PwrDiscATestComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Trns2_PwrDiscBTestComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_BKCPPC_APPL_VAR) BkCpPc_Trns2_PwrDiscClosed_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_BkCpPc, RTE_CONST, RTE_CONST) Rte_Inst_Sa_BkCpPc;
...
#    error "The magic number of the generated file <C:/_Synergy_Projects/Working/BkCpPc-nz63rn/BkCpPc/utp/contract/Sa_BkCpPc/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
