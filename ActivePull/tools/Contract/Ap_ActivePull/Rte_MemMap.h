...
#   error "The magic number of the generated file <C:/_Synergy_Projects/EA3_Working/ActivePull/tools/contract/Ap_ActivePull/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
