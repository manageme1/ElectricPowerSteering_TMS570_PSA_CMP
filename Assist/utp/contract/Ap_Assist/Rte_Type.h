...
struct Rte_CDS_Ap_Assist
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_AssistDDFactor_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_BaseAssistCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_DftAsstTbl_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_DutyCycleLevel_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_DwnldAsstGain_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_HwTrqHysAdd_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_HwTrq_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_IpTrqOvr_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_VehSpd_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSIST_APPL_VAR) Assist_Per1_WIRCmdAmpBlnd_MtrNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_Assist, RTE_CONST, RTE_CONST) Rte_Inst_Ap_Assist;
...
#    error "The magic number of the generated file <C:/Workspace/Assist-CBD_Assist/SF01_008.0/Assist/utp/contract/Ap_Assist/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
