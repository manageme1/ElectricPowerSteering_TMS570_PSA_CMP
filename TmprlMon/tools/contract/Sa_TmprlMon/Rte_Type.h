...
#  define NTC_Num_AngleCntrlFltC ((NTCNumber)226u)
# endif
...
#  define NTC_Num_AngleCntrlFltD ((NTCNumber)227u)
# endif
...
#  define NTC_Num_AngleCntrlFltFG ((NTCNumber)228u)
# endif
...
struct Rte_CDS_Sa_TmprlMon
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_TMPRLMON_APPL_VAR) TmprlMon_Per2_TMFTestComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_TMPRLMON_APPL_VAR) TmprlMon_Per2_TMFTestStart_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_TmprlMon, RTE_CONST, RTE_CONST) Rte_Inst_Sa_TmprlMon;
...
#    error "The magic number of the generated file <C:/Sankar/Synergy/Working/TmprlMon-pznywf/TmprlMon/tools/contract/Sa_TmprlMon/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
