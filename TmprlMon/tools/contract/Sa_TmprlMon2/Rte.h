...
#    error "The magic number of the generated file <C:/Sankar/Synergy/Working/TmprlMon-pznywf/TmprlMon/tools/contract/Sa_TmprlMon2/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
