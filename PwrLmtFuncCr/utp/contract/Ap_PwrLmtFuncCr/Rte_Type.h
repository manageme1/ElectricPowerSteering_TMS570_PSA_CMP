...
struct Rte_CDS_Ap_PwrLmtFuncCr
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per1_AltFaultActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per1_CntDisMtrTrqCmdMRF_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per1_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per1_MRFMtrTrqCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per1_MotorVelMRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per1_PosServEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per1_Vecu_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per2_CntDisMtrTrqCmdMRF_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per2_FltTrqLmt_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per2_ThresholdExceeded_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNCCR_APPL_VAR) PwrLmtFuncCr_Per2_Vecu_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_PwrLmtFuncCr, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PwrLmtFuncCr;
...
#    error "The magic number of the generated file <C:/_Synergy_Projects/Working/PwrLmtFuncCr-nz63rn/PwrLmtFuncCr/utp/contract/Ap_PwrLmtFuncCr/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
