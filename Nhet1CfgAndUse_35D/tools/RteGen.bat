...
attrib -r "..\tools\contract\*.h" >>logfile.txt
 ...
 set dcf=Cd_Nhet1CfgAndUse


set SWC=Cd_Nhet1CfgAndUse


..\..\Autosar3Tools\RteGen\dvrtegen -d "..\autosar\%dcf%.dcf" -m %SWC% -g i -o "..\src" >>logfile.txt
..\..\Autosar3Tools\RteGen\dvrtegen -d "..\autosar\%dcf%.dcf" -m %SWC% -g c -o "..\tools\contract\Cd_Nhet1CfgAndUse" >>logfile.txt
