...
# endif
# if (defined RTE_CONST_NTC_Num_LxaTrqOvMode) || (defined NTC_Num_LxaTrqOvMode)
#  if (!defined RTE_CONST_NTC_Num_LxaTrqOvMode) || (RTE_CONST_NTC_Num_LxaTrqOvMode != 235u)
#   error "Enumeration constant <NTC_Num_LxaTrqOvMode> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_LxaTrqOvMode (235u)
#  define NTC_Num_LxaTrqOvMode ((NTCNumber)235u)
# endif
# if (defined RTE_CONST_NTC_Num_LxaHwTrqMode) || (defined NTC_Num_LxaHwTrqMode)
#  if (!defined RTE_CONST_NTC_Num_LxaHwTrqMode) || (RTE_CONST_NTC_Num_LxaHwTrqMode != 236u)
#   error "Enumeration constant <NTC_Num_LxaHwTrqMode> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_LxaHwTrqMode (236u)
#  define NTC_Num_LxaHwTrqMode ((NTCNumber)236u)
# endif
# if (defined RTE_CONST_NTC_Num_LxaHwVelMode) || (defined NTC_Num_LxaHwVelMode)
#  if (!defined RTE_CONST_NTC_Num_LxaHwVelMode) || (RTE_CONST_NTC_Num_LxaHwVelMode != 237u)
#   error "Enumeration constant <NTC_Num_LxaHwVelMode> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_LxaHwVelMode (237u)
#  define NTC_Num_LxaHwVelMode ((NTCNumber)237u)
# endif
...
struct Rte_CDS_Cd_Nhet1CfgAndUse
{
  /* Data Handles section */
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_CD_NHET1CFGANDUSE_APPL_VAR) Nhet1CfgAndUse_Per2_HwTq1Polarity_Cnt_s08;
  P2VAR(Rte_DE_SigQlfr_State_enum, TYPEDEF, RTE_CD_NHET1CFGANDUSE_APPL_VAR) Nhet1CfgAndUse_Per2_HwTq1Qlfr_State_enum;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_NHET1CFGANDUSE_APPL_VAR) Nhet1CfgAndUse_Per2_HwTq1RollgCntr_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_NHET1CFGANDUSE_APPL_VAR) Nhet1CfgAndUse_Per2_HwTq1Val_HwNm_f32;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_CD_NHET1CFGANDUSE_APPL_VAR) Nhet1CfgAndUse_Per2_HwTq2Polarity_Cnt_s08;
  P2VAR(Rte_DE_SigQlfr_State_enum, TYPEDEF, RTE_CD_NHET1CFGANDUSE_APPL_VAR) Nhet1CfgAndUse_Per2_HwTq2Qlfr_State_enum;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_NHET1CFGANDUSE_APPL_VAR) Nhet1CfgAndUse_Per2_HwTq2RollgCntr_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_NHET1CFGANDUSE_APPL_VAR) Nhet1CfgAndUse_Per2_HwTq2Val_HwNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Cd_Nhet1CfgAndUse, RTE_CONST, RTE_CONST) Rte_Inst_Cd_Nhet1CfgAndUse;
...
#    error "The magic number of the generated file <C:/Users/rzk04c/Documents/Synergy/EA3/Nhet1CfgAndUse/tools/contract/Cd_Nhet1CfgAndUse/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
