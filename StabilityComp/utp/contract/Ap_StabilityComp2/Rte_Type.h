...
struct Rte_CDS_Ap_StabilityComp2
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STABILITYCOMP2_APPL_VAR) StabilityComp2_Per1_AssistDDFactor_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STABILITYCOMP2_APPL_VAR) StabilityComp2_Per1_AsstFWActive_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STABILITYCOMP2_APPL_VAR) StabilityComp2_Per1_CombinedAssist_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STABILITYCOMP2_APPL_VAR) StabilityComp2_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STABILITYCOMP2_APPL_VAR) StabilityComp2_Per1_SysAssistCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STABILITYCOMP2_APPL_VAR) StabilityComp2_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_StabilityComp2, RTE_CONST, RTE_CONST) Rte_Inst_Ap_StabilityComp2;
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/CBD/StabilityComp/utp/contract/Ap_StabilityComp2/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
