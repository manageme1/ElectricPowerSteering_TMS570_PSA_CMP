...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/CBD/StabilityComp/utp/contract/Ap_StabilityComp2/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
