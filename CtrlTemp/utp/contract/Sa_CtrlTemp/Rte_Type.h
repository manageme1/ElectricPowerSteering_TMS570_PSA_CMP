...
struct Rte_CDS_Sa_CtrlTemp
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CTRLTEMP_APPL_VAR) CtrlTemp_Init1_FiltMeasTemp_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CTRLTEMP_APPL_VAR) CtrlTemp_Init1_TemperatureADC_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CTRLTEMP_APPL_VAR) CtrlTemp_Per1_DiagStsTempRdPrf_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CTRLTEMP_APPL_VAR) CtrlTemp_Per1_FiltMeasTemp_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CTRLTEMP_APPL_VAR) CtrlTemp_Per1_TemperatureADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CTRLTEMP_APPL_VAR) CtrlTemp_Per2_AmbTemp_DegC_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_CtrlTemp, RTE_CONST, RTE_CONST) Rte_Inst_Sa_CtrlTemp;
...
#    error "The magic number of the generated file <C:/_Synergy_Projects/Working/CtrlTemp-nz63rn/CtrlTemp/utp/contract/Sa_CtrlTemp/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
