...
#   error "The magic number of the generated file <C:/Synergy_projects/Return-lz4p8n/Return/utp/contract/Ap_Return/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
