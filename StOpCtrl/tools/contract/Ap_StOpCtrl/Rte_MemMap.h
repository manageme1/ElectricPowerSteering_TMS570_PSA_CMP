...
#   error "The magic number of the generated file <C:/Synergy_KK/working/StOpCtrl-nz4qtt/StOpCtrl/tools/contract/Ap_StOpCtrl/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
