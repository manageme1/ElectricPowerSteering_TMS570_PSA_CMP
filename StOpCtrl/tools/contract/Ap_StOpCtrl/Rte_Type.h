...
struct Rte_CDS_Ap_StOpCtrl
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STOPCTRL_APPL_VAR) StOpCtrl_Per1_LoaRateLimit_UlspS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STOPCTRL_APPL_VAR) StOpCtrl_Per1_LoaScaleFctr_Uls_f32;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STOPCTRL_APPL_VAR) StOpCtrl_Per1_StrtStopRateLimit_UlspS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STOPCTRL_APPL_VAR) StOpCtrl_Per1_StrtStopScaleFctr_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STOPCTRL_APPL_VAR) StOpCtrl_Per1_SysStReqDi_Cnt_lgc;
...
#    error "The magic number of the generated file <C:/Synergy_KK/working/StOpCtrl-nz4qtt/StOpCtrl/tools/contract/Ap_StOpCtrl/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
