...
struct Rte_CDS_Ap_CtrlPolarityBrshlss
{
  /* PIM Handles section */
  P2VAR(Polarity_DataType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_Polarity_Cnt_Str;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_CtrlPolarityBrshlss, RTE_CONST, RTE_CONST) Rte_Inst_Ap_CtrlPolarityBrshlss;
...
#    error "The magic number of the generated file <C:/Ford_Intergration/Ford_S550_P552/CtrlPolarityBrshlss/utp/contract/Ap_CtrlPolarityBrshlss/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
