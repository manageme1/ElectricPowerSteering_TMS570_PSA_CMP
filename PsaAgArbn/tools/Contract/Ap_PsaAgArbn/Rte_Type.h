...
#  define NTC_Num_MotBasdHwAgFlt ((NTCNumber)153u)
# endif
...
# define PsaAgArbnDiagCmdReq_Enum_LowerLimit ((PsaAgArbnDiagCmdReq_Enum)0u)
# define PsaAgArbnDiagCmdReq_Enum_UpperLimit ((PsaAgArbnDiagCmdReq_Enum)2u)
...
#  define PSAAGARBNDIAGCMDREQ_DIAGNOACTN ((PsaAgArbnDiagCmdReq_Enum)0u)
# endif
...
#  define PSAAGARBNDIAGCMDREQ_DIAGRSTREQ ((PsaAgArbnDiagCmdReq_Enum)1u)
# endif
...
#  define PSAAGARBNDIAGCMDREQ_DIAGCENTR ((PsaAgArbnDiagCmdReq_Enum)2u)
# endif

# define Rte_TypeDef_PsaAgArbnSt_Enum
typedef uint8 PsaAgArbnSt_Enum;
# define PsaAgArbnSt_Enum_LowerLimit ((PsaAgArbnSt_Enum)0u)
# define PsaAgArbnSt_Enum_UpperLimit ((PsaAgArbnSt_Enum)7u)
...
#  define PSAAGARBNST_STININ ((PsaAgArbnSt_Enum)0u)
# endif
...
#  define PSAAGARBNST_STPND ((PsaAgArbnSt_Enum)1u)
# endif
...
#  define PSAAGARBNST_STNOSYNCN ((PsaAgArbnSt_Enum)2u)
# endif
...
#  define PSAAGARBNST_STESCSYNCN ((PsaAgArbnSt_Enum)3u)
# endif
...
#  define PSAAGARBNST_STDIAGSYNCN ((PsaAgArbnSt_Enum)4u)
# endif
...
#  define PSAAGARBNST_STALTVSYNCN ((PsaAgArbnSt_Enum)5u)
# endif
...
#  define PSAAGARBNST_UNUSED ((PsaAgArbnSt_Enum)6u)
# endif
...
#  define PSAAGARBNST_STFAIL ((PsaAgArbnSt_Enum)7u)
# endif
...
#  define D_PSAAGARBNSTINIT_CNT_ENUM ((PsaAgArbnSt_Enum)0u)
# endif
...
struct Rte_CDS_Ap_PsaAgArbn
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Init1_EscOffsEna_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_AbsltHwPosnLvl1_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_AbsltHwPosnLvl2_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_AbsltHwPosnPrecision_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_AbsltHwPosnVld_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_AbsltHwPosn_HwDeg_f32;
  P2VAR(Rte_DE_PsaAgArbnSt_Enum, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_AgArbnStToSerlCom_Cnt_enum;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_AlignedCumMechMtrPosStatus_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_AlignedRelHwPos_HwDeg_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_CumMechMtrPosStatus_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_EscAckFromSerlCom_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_EscDataVldFromSerlCom_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_EscOffsEna_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_EscOffsFromSerlCom_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_EscPrecisionFromSerlCom_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_HandwheelAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_HandwheelPosition_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_MtrVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_RelHwPos_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_RelHwPosnToSerlCom_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_RelHwPosnVldToSerlCom_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_SensorlessAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_SensorlessHwPos_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_TorqueCmdCRF_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSAAGARBN_APPL_VAR) PsaAgArbn_Per1_VehicleSpeed_Kph_f32;
  /* PIM Handles section */
  P2VAR(PsaAgAnLrndOffs_Str, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PsaAgArbnLrndOffsData;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_PsaAgArbn, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PsaAgArbn;
...
#    error "The magic number of the generated file <C:/Users/nz2999/Documents/Synergy/ccm_wa/ses_dev_ea3/PsaAgArbn-nz2999/PsaAgArbn/tools/contract/Ap_PsaAgArbn/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
