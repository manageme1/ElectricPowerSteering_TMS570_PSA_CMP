...
struct Rte_CDS_Ap_AstLmt
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASTLMT_APPL_VAR) AstLmt_Per1_EotActvCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ASTLMT_APPL_VAR) AstLmt_Per1_HwTqLoaMtgtnEn_Cnt_lgc;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASTLMT_APPL_VAR) AstLmt_Per1_TloaCmd_MtrNm_f32;
...
#    error "The magic number of the generated file <C:/Synergy_KK/working/AstLmt_CM-nz4qtt/AstLmt_CM/tools/contract/Ap_AstLmt/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
