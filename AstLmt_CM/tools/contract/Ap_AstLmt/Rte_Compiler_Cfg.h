...
#    error "The magic number of the generated file <C:/Synergy_KK/working/AstLmt_CM-nz4qtt/AstLmt_CM/tools/contract/Ap_AstLmt/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
