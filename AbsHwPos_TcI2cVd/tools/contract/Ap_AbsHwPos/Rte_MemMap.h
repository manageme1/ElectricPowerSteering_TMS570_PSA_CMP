...
#   error "The magic number of the generated file <C:/Synergy_EA3/working/AbsHwPos_TcI2cVd/tools/contract/Ap_AbsHwPos/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
