...
struct Rte_CDS_Ap_AbsHwPos
{
  /* Data Handles section */
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Init1_HwPosSource_Cnt_u16;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Init1_ManufMode_Cnt_enum;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Init1_SrlComHwPosStatus_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_AlignedCumMechMtrPosCRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_AlignedRelHwPos_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_ComplError_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_CumMechMtrPosCRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_RelHwPos_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_DiagStatusHwPosReducedPerf_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_HandwheelAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_HandwheelPosition_HwDeg_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_HwPosSource_Cnt_u16;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_I2CHwAbsPosValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_I2CHwAbsPos_HwDeg_f32;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_ManufMode_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_SensorlessAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_SensorlessHwPos_HwDeg_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_SrlComHwPosStatus_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_SrlComHwPos_HwDeg_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_TurnsCntrValidity_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per3_I2CHwAbsPosValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per3_I2CHwAbsPos_HwDeg_f32;
  /* PIM Handles section */
  P2VAR(EOLHwPosTrimType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_EOLVehCntrOffset;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_AbsHwPos, RTE_CONST, RTE_CONST) Rte_Inst_Ap_AbsHwPos;
...
#    error "The magic number of the generated file <C:/Synergy_EA3/working/AbsHwPos_TcI2cVd/tools/contract/Ap_AbsHwPos/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
