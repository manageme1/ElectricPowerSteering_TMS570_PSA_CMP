...
#  if (!defined RTE_CONST_D_VEHWHLBASEINIT_MM_F32) || (RTE_CONST_D_VEHWHLBASEINIT_MM_F32 != 3000)
#   error "Constant value <D_VEHWHLBASEINIT_MM_F32> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_D_VEHWHLBASEINIT_MM_F32 (3000)
#  define D_VEHWHLBASEINIT_MM_F32 ((Float)3000)
# endif
...
struct Rte_CDS_Ap_TrqLOA
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_HandwheelAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_HandwheelPosition_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_MotAgLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_MtrVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_TrqLOAAvail_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_TrqLOACmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_TrqLoaDi_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_VehWhlBasVld_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_VehWhlBas_mm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_VehicleLatAccelValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_VehicleLatAccel_MpSecSq_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQLOA_APPL_VAR) TrqLOA_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_TrqLOA, RTE_CONST, RTE_CONST) Rte_Inst_Ap_TrqLOA;
...
#    error "The magic number of the generated file <C:/SynergyEA3/Working/TrqLOA/tools/contract/Ap_TrqLOA/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
