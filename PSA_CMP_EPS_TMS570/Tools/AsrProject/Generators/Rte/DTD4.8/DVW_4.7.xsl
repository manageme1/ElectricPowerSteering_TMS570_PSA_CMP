...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="xml" version="1.0" encoding="ISO-8859-1" standalone="no" doctype-system="..\DTD4.8\DVW.DTD"/>
...
<!-- DVW element rule -->
<!-- Set DTD version to 4.8, no external conversion required  -->
