...
padding:0cm 0cm 3.0pt 0cm">
	...
	<xsl:template match='ModuleConfig' name="Modules" priority="2">
		<div style="mso-element:para-border-div;border:none;border-bottom:solid windowtext 3.0pt; padding:0cm 0cm 3.0pt 0cm">
			<h2>'<xsl:value-of select="@Name"/>' Configuration
			</h2>
			<xsl:apply-templates/>
		</div>
	</xsl:template>
	<!-- ################################################## General ################################################## -->
	<xsl:template match="TableStats" name="stats" priority="3">
		<div style="mso-element:para-border-div;border:none;border-bottom:solid windowtext 3.0pt; padding:0cm 0cm 3.0pt 0cm"/>
	...
	<xsl:template match="TableChanged" priority="3">
	...
	<xsl:template match="TableInserted" priority="3">
		<div style="mso-element:para-border-div;border:none;border-bottom:solid windowtext 1.0pt; padding:0cm 0cm 3.0pt 0cm">
			<h3>
				<xsl:value-of select="@Rows"/>
				<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;ndash;&amp;nbsp;</xsl:text>
	...
	<xsl:template match="TableDeleted" priority="3">
		<div style="mso-element:para-border-div;border:none;border-bottom:solid windowtext 1.0pt; padding:0cm 0cm 3.0pt 0cm">
			<h3>
				<xsl:value-of select="@Rows"/>
				<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;ndash;&amp;nbsp;</xsl:text>
