...
struct Rte_CDS_Sa_CDDInterface10
{
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Init1_ESCOffsCfgSeld_Cnt_lgc;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Init1_MtrPosPolarity_Cnt_s08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Init1_TurnsCounterSelected_Cnt_lgc;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_CommOffset_Cnt_u16;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_ESCOffsCfgSeld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_IvtrLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_MRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_MotCurrLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_MtrCurr1TempOffset_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_MtrCurr2TempOffset_Volt_f32;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_MtrPosPolarity_Cnt_s08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE10_APPL_VAR) CDDInterface10_Per1_Vecu_Volt_f32;
...
#    error "The magic number of the generated file <C:/Components/PSA_CMP/PSA_CMP_EPS_TMS570/SwProject/CDDInterface/utp/contract/Sa_CDDInterface10/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
