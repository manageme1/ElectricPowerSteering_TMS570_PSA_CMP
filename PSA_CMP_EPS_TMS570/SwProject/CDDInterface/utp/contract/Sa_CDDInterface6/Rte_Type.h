...
#  endif
#  if (defined RTE_CONST_FLTINJ_TARSTMOMDVACT) || (defined FLTINJ_TARSTMOMDVACT)
#   if (!defined RTE_CONST_FLTINJ_TARSTMOMDVACT) || (RTE_CONST_FLTINJ_TARSTMOMDVACT != 68U)
#    error "Enumeration constant <FLTINJ_TARSTMOMDVACT> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_FLTINJ_TARSTMOMDVACT (68U)
#   define FLTINJ_TARSTMOMDVACT (68U)
#  endif
...
struct Rte_CDS_Sa_CDDInterface6
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Init1_AVASelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Init1_CAVHCSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Init1_CityParkSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Init1_LXASelected_Cnt_lgc;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Init1_MtrElecMechPolarity_Cnt_s08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Init1_MultiModeSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Init1_STTdSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_AVASelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_CAVHCSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_CityParkSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_DampingSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_DftAsstTbl_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_DrivingDynSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_DwnldAsstGain_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_EOTImpactSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_EOTThermalSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_EnergyModeStateType, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_EnergyModeState_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_EngONSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_FreqDepDmpSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_FricLrnSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_HysAddSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_HystCompSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_KinIntDiagSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_LXASelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_LimitSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_LoaMgrDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_MfgDiagInhibit_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_ModIdxSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_MtrElecMechPolarity_Cnt_s08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_MtrParmNrmLrnSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_MtrVelNrmLrnSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_MultIgnSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_MultiModeSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_ParkAstSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_PullCompSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_ReturnSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_RxMsgsSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_STTdSelected_Cnt_lgc;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_SrlComSvcDft_Cnt_b32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_ThermalDCSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_TrqRmpSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE6_APPL_VAR) CDDInterface6_Per1_WhlImbRejSrlComSvcDft_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_CDDInterface6, RTE_CONST, RTE_CONST) Rte_Inst_Sa_CDDInterface6;
...
#    error "The magic number of the generated file <C:/Components/PSA_CMP/PSA_CMP_EPS_TMS570/SwProject/CDDInterface/utp/contract/Sa_CDDInterface6/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
