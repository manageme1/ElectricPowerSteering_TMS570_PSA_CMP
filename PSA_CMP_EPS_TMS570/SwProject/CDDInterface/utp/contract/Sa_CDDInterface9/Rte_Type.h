...
struct Rte_CDS_Sa_CDDInterface9
{
  /* Data Handles section */
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Init1_IgnCnt_Cnt_u16;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Init1_MECTemp_Cnt_u08;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Init1_MEC_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_ADCMtrCurr1_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_ADCMtrCurr2_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_CorrMtrCurrPosition_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_CorrMtrPosElec_Rev_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_CorrectedElecMtrPos_Rev_u0p16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_CumMechMtrPos_Rev_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_Die1RxError_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_Die1RxMtrPos_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_Die1RxRevCtr_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_Die1UnderVoltgFltAccum_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_Die2RxError_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_Die2RxMtrPos_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_Die2RxRevCtr_Cnt_u16;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_ExpectedOnTimeA_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_ExpectedOnTimeB_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_ExpectedOnTimeC_Cnt_u32;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_LRPRPhaseadvanceCaptured_Cnt_s16;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MEC_Cnt_enum;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MechMtrPos1Timestamp_USec_u32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MechMtrPos1_Rev_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MechMtrPos2Timestamp_USec_u32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_ModIdxFinal_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MtrCurrDax_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MtrCurrK1_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MtrCurrK2_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MtrCurrQaxFinalRef_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MtrCurrQax_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MtrVoltDax_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MtrVoltQax_Volt_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_RxMtrPosParityAccum_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_SysCCorrMtrPosElec_Rev_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_SysCVSwitchADC_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_UncorrMechMtrPos1_Rev_u0p16;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_CDDInterface9, RTE_CONST, RTE_CONST) Rte_Inst_Sa_CDDInterface9;
...
#    error "The magic number of the generated file <C:/Components/PSA_CMP/PSA_CMP_EPS_TMS570/SwProject/CDDInterface/utp/contract/Sa_CDDInterface9/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
