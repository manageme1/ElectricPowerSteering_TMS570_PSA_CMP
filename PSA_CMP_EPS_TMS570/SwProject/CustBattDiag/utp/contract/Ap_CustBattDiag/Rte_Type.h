...
struct Rte_CDS_Ap_CustBattDiag
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per1_Batt_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_Batt_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_CTerm_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_DmdDelestDa_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_EngOn_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_EtatMT_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_SttdSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_ValidEngineStatus_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTBATTDIAG_APPL_VAR) CustBattDiag_Per2_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_CustBattDiag, RTE_CONST, RTE_CONST) Rte_Inst_Ap_CustBattDiag;
...
#    error "The magic number of the generated file <C:/Components/PSA_CMP/PSA_CMP_EPS_TMS570/SwProject/CustBattDiag/utp/contract/Ap_CustBattDiag/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
