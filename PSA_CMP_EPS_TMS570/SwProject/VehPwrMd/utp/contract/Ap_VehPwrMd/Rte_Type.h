...
struct Rte_CDS_Ap_VehPwrMd
{
  ...
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_DmdDelestDASts_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_DmdDelestDaVld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_EngONSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_EngOn_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_EtatMT_Cnt_u08;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_MEC_Cnt_enum;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_OutputRampMult_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_RampDwnStatusComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_STTdSelected_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_SrlComVehSpd_Kph_f32;
...
#    error "The magic number of the generated file <C:/Components/PSA_CMP/PSA_CMP_EPS_TMS570/SwProject/VehPwrMd/utp/contract/Ap_VehPwrMd/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
