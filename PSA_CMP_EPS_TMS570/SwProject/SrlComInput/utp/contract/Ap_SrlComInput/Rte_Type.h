...
struct Rte_CDS_Ap_SrlComInput
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_ApaVehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_CAVHCSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_CPKOK_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_CityParkSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_ESCOffsCfgSeld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_ElectronicIntegration_Cnt_lgc;
  P2VAR(Rte_DE_EnergyModeStateType, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_EnergyModeState_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_EscPrecisionFromSerlCom_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_LXASelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_LxaInpVld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_MultiModeVld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_MultimodeSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_STTdSelected_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Init_SrlComVehSpd_Kph_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDat4V2Bsi_552_CompteurTemporelVehiculeRaw_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDat4V2Bsi_552_ISDAT4V2BSI552MsgRxTimeRaw_MSec_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDat4V2Bsi_552_Kilometrage_Cnt_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDatBsi_3F2_LxaSeln_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDatBsi_3F2_LxaTqFacReq_Uls_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDatBsi_432_EtatPrincipSev_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDatBsi_432_EtatReseauElec_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDatBsi_432_PowerSupplies_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_MsgIsDatBsi_432_ShuntPosition_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per1_Batt_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per1_BusOff_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per1_CTermActive_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per1_ComputerRazGCTRaw_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per1_ESCOffsCfgSeld_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per1_EtatMTRaw_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per1_RxMsgsSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per1_VehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_APAAuthn_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_APARequest_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_AbsActv_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_AngleVolant_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_ApaRelaxReq_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_ApaVehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_BSIDataMissing_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_CMMDataMissing_Cnt_lgc;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_CONSANGLECPK_Cnt_s16;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_CPKOK_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_ColAngleSetpoint_HwDeg_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_DMDFCTCPK_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_DefaultVehSpd_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_ElectronicIntegration_Cnt_lgc;
  P2VAR(Rte_DE_EnergyModeStateType, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EnergyModeState_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EngOn_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EscAckFromSerlCom_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EscActv_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EscDataVldFromSerlCom_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EscEna_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EscFltPrsnt_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EscOffsFromSerlCom_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_EscPrecisionFromSerlCom_HwDeg_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_IgnTimeOff_Cnt_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_LxaInpVld_Cnt_lgc;
  P2VAR(Rte_DE_PsaLxaSt_Cnt_enum, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_LxaStateFilt_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_MultiModeVld_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_PosSrvoHwAngle_HwDeg_f32;
  P2VAR(Rte_DE_PsaTunModSt_Cnt_enum, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_ReqModeDAFinal_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_SerialComAngleValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_SrlComVehSpd_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_ValidEngineStatus_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_VehTimeValid_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_VehicleLatAccelValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_VehicleLatAccel_MpSecSq_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_CompteurTemporelVehiculeRaw_Cnt_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_EtatPrincipSev_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_EtatReseauElec_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_ISDAT4V2BSI552MsgRxTimeRaw_MSec_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_Kilometrage_Cnt_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_LxaSeln_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_LxaTqFacReq_Uls_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_PowerSupplies_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Trns2_ShuntPosition_Cnt_u08;
  /* PIM Handles section */
  P2VAR(Boolean, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_ElecIntData;
  P2VAR(ShutdownTimeType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_ShutdownTimeData;
  P2VAR(UInt8, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_VVHTYPEData;
...
#    error "The magic number of the generated file <C:/Components/PSA_CMP/PSA_CMP_EPS_TMS570/SwProject/SrlComInput/utp/contract/Ap_SrlComInput/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
