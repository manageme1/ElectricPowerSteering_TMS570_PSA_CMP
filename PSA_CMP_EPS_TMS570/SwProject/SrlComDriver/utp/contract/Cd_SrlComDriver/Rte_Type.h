 ...
 *  Generated at:  Mon Apr 30 20:03:44 2018
 *
...
struct Rte_CDS_Cd_SrlComDriver
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Init1_CAVHCSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Init1_CityParkSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Init1_ESCOffsCfgSeld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Init1_LXASelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Init1_MultimodeSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Init1_STTdSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_BusOff_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ElectronicIntegration_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_TMFTestComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_TxEnabled_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Cd_SrlComDriver, RTE_CONST, RTE_CONST) Rte_Inst_Cd_SrlComDriver;
...
#    error "The magic number of the generated file <C:/Components/PSA_CMP/PSA_CMP_EPS_TMS570/SwProject/SrlComDriver/utp/contract/Cd_SrlComDriver/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
