...
struct Rte_CDS_Ap_FaultLog
{
  /* Data Handles section */
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_FAULTLOG_APPL_VAR) FaultLog_Per1_CompteurTemporelVehicule_Cnt_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_FAULTLOG_APPL_VAR) FaultLog_Per1_ComputerRazGCT_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_FAULTLOG_APPL_VAR) FaultLog_Per1_ISDAT4V2BSI552MsgRxTime_MSec_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_FAULTLOG_APPL_VAR) FaultLog_Per1_TxEnabled_Cnt_lgc;
  /* PIM Handles section */
  P2VAR(FaultLogType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_FaultLog;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_FaultLog, RTE_CONST, RTE_CONST) Rte_Inst_Ap_FaultLog;
...
#    error "The magic number of the generated file <C:/Users/nzx5jd/Desktop/DVOutput/Ap_FaultLog/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
