...
struct Rte_CDS_IoHwAb10
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_Init_BattSwitched_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_Init_Batt_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_Init_SysCVSwitch_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_Init_TemperatureADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_ReadAdc_BattSwitched_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_ReadAdc_Batt_Volt_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_ReadAdc_SysCVSwitchADC_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_ReadAdc_SysCVSwitch_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB10_APPL_VAR) IoHwAb_ReadAdc_TemperatureADC_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_IoHwAb10, RTE_CONST, RTE_CONST) Rte_Inst_IoHwAb10;
...
#    error "The magic number of the generated file <C:/Users/nzx5jd/Desktop/DVOutput/IoHwAb10/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
