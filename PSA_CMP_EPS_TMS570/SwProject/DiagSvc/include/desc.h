/* -----------------------------------------------------------------------------
  ...
  Generated by CANdelaGen, Sat Apr 21 11:15:40 2018
...
#define DESC_DISABLE_COMM_CONTROL_RX_PATH
/* Disable response on requests which SID are in range 
...
/* Dynamic communication parameters will not be supported. */
#define DESC_DISABLE_DYN_COM_CTRL_PARAM
...
/* Combinable PID with dynamic data length will be supported. */
#define DESC_ENABLE_DYN_DID_RES_LENGTH
...
#define DIAG_CANDESC__CORE_RELEASE_VERSION                           0x44
#define DESC_VERSION                                                 0x0507
#define DESC_RELEASE_VERSION                                         0x44
...
#define DESC_PUBLIC_INTERFACE_MAGIC_NUMBER                           13716
...
#define kDescNrcWritingToMemoryFailed                                0xA1
#define kDescNrcBadCRC                                               0xA2
#define kDescNrcNoMemoryAvailable                                    0xA3
...
#define kDescCallCycleUs                                             5000
#define kDescS1TimerTicks                                            1000
/* P2 timeout in DescTask cycles. */
#define kDescP2Ticks                                                 9
/* P2Ex timeout in DescTask cycles. */
#define kDescP2StarTicks                                             999
...
#define kDescStateSessionRemote                                      ((DescStateGroup)0x08)
#define kDescStateSessionNexteer                                     ((DescStateGroup)0x10)
#define kDescNumStateSecurityAccess                                  2
#define kDescStateSecurityAccessLocked                               ((DescStateGroup)0x01)
#define kDescStateSecurityAccessVariant_Coding                       ((DescStateGroup)0x02)
...
#ifdef kDescP2Ticks
# undef kDescP2Ticks
# define kDescP2Ticks			30
#endif

/* P2Ex timeout in DescTask cycles. */
#ifdef kDescP2StarTicks
# undef kDescP2StarTicks
# define kDescP2StarTicks		30
#endif

/* P2 timeout time in 1ms resolution. */
#ifdef kDescTimeValueP2
# undef kDescTimeValueP2
# define kDescTimeValueP2		200
#endif

/* P2Ex timeout time in 10 ms resolution. */
#ifdef kDescTimeValueP2Star
# undef kDescTimeValueP2Star
# define kDescTimeValueP2Star		20
#endif
...
typedef struct
{
  ...
  DescBitType  reqCommChannel      :4; /* up to 16 CAN channels */
  DescBitType  commCtrlChannel     :4; /* up to 16 CAN channels (former commChannelCtrlTx)*/
