...
static void DESC_API_CALLBACK_TYPE DescOemControlNexteer_Session(DescMsgContext* pMsgContext);
...
V_MEMROM0 static V_MEMROM1 DescSvcInst V_MEMROM2 g_descSvcInst[kDescSvcInstNumItems] = 
{
  ...
  {   2, { 0x01, 0x01, 0 }, { 0x1D, 0x03, 0x00 },                      4,    0, DescOemControlNexteer_Session } /* $10 $7E */, 
  ...
  {   2, { 0x03, 0x03, 0 }, { 0x10, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescECUResetNexteerReset } /* $11 $60 */, 
  ...
  {   4, { 0x01, 0x01, 0 }, { 0x10, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteFD19_Nexteer_Manufacturing_Enable_Counter_MEC } /* $2E $FD $19 */, 
  ...
  {  67, { 0x01, 0x01, 0 }, { 0x10, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteFDAC_Nexteer_Manufacturing_Scratchpad } /* $2E $FD $AC */, 
...
V_MEMROM0 static V_MEMROM1 DescPidInst V_MEMROM2 g_descPIDInfo[kDescNumPids] = 
{
  ...
  { 0xFD10,   10, { { 0x10, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadFD10_Nexteer_CCP_XCP_Transmit_and_Receive_IDs }, 
  { 0xFD12,   28, { { 0x10, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadFD12_Current_Mode_Offset_and_Gain }, 
  { 0xFD13,   75, { { 0x10, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadFD13_Read_Nexteer_DTCs }, 

  { 0xFD17,    2, { { 0x10, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadFD17_Flash_Memory_Size }, 
  { 0xFD19,    1, { { 0x10, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadFD19_Nexteer_Manufacturing_Enable_Counter_MEC }, 
  ...
  { 0xFDAC,   64, { { 0x10, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadFDAC_Nexteer_Manufacturing_Scratchpad }, 
  ...
  { 0xFEFE,   56, { { 0x10, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadFEFE_Nexteer_Flash_Bootloader_Identification }, 
...
/*  ********************************************************************************
 * Function name:DescOemControlNexteer_Session
 * Description:Processes the session change request, parametrizing the common processing
 * function.
 * Returns:  nothing
 * Parameter(s):
...
static void DESC_API_CALLBACK_TYPE DescOemControlNexteer_Session(DescMsgContext* pMsgContext)
{
  DescOemPrepareSessionControl(pMsgContext, kDescStateSessionNexteer);
}
