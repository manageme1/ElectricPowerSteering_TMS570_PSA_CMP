...
/* --- Common Defines --- */
#define NEXTEER_SESSION						kDescStateSessionNexteer
...
#define D_EPSNRCNOTNEXTEERPROD_CNT_U08		D_EPSNRCREQOUTOFRANGE_CNT_U08
...
#define CM_CyberSecNexteerLocked_Cnt_lgc    FALSE /* Nexteer Manual Edit */
#define CM_VehicleSpeedValid_Cnt_lgc        Rte_SrlComInput_VehicleSpeedValid_Cnt_lgc /* Nexteer Manual Edit */
extern VAR(Boolean, RTE_VAR_INIT) Rte_SrlComInput_VehicleSpeedValid_Cnt_lgc; /* Nexteer Manual Edit */
