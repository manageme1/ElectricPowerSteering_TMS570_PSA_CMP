...
# 2007/08/06   1.01     Gz   Added support of AUTOSAR Dem                     #
# 2007-10-11   1.02     Hrs  Added generated source file Dem_PBCfg.c          #
# 2008/04/30   1.03     fbg  Changes for ASR library support                  #
# 2008-06-18   2.00     Hrs  Added generated source file Dem_Lcfg.c (ASR 3.0) #
# 2008-06-24   2.00.01   Get  Changed DEM_FILES to Dem_Files        #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.4                                                       #
###############################################################################
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Dem_PBcfg.c $(GENDATA_DIR)\Dem_Lcfg.c
