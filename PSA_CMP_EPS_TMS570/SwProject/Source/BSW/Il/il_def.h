/* Kernbauer Version: 1.14 Konfiguration: Il_Vector Erzeugungsgangnummer: 144 */
...
/* Oem Check *********************************************************************************************************/
# if defined ( VGEN_GENY )
#  if defined ( IL_TYPE_PSA )
#   if defined ( IL_ENABLE_RX_MODE_SIGNALS )
#    error "Multiplexed messages are not supported for Oem Psa!"
#   endif
