...
# 2007/07/06   1.01     Si   Added support of MICROSAR RTE                    #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
##############################################################
# RTE_CONFIG_PATH: (not used for Vector)
# The Variable RTE_CONFIG_PATH is optional. It allows the
...
# targets, then different RTE configurations of different
# directories will be necessary. Therefor the variable
# RTE_CONFIG_PATH should be used.
#
# For example:
# RTE_CONFIG_PATH = $(PROJECT_ROOT)\source\network\v850
# RTE_CONFIG_PATH = $(PROJECT_ROOT)\source\network\st10
# RTE_CONFIG_PATH = $(PROJECT_ROOT)\source\network\v850
#
