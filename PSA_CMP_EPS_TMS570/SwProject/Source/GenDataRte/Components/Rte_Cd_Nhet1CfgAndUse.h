...
#  define Rte_IRead_Nhet1CfgAndUse_Per2_HwTq1Polarity_Cnt_s08() \
  (Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq1Polarity_Cnt_s08.value)

#  define Rte_IRead_Nhet1CfgAndUse_Per2_HwTq2Polarity_Cnt_s08() \
  (Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq2Polarity_Cnt_s08.value)

#  define Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq1Qlfr_State_enum(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq1Qlfr_State_enum.value = (data) \
  )

#  define Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq1Qlfr_State_enum() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq1Qlfr_State_enum.value)

#  define Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq1RollgCntr_Cnt_u08(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq1RollgCntr_Cnt_u08.value = (data) \
  )

#  define Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq1RollgCntr_Cnt_u08() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq1RollgCntr_Cnt_u08.value)

#  define Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq1Val_HwNm_f32(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq1Val_HwNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq1Val_HwNm_f32() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq1Val_HwNm_f32.value)

#  define Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq2Qlfr_State_enum(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq2Qlfr_State_enum.value = (data) \
  )

#  define Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq2Qlfr_State_enum() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq2Qlfr_State_enum.value)

#  define Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq2RollgCntr_Cnt_u08(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq2RollgCntr_Cnt_u08.value = (data) \
  )

#  define Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq2RollgCntr_Cnt_u08() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq2RollgCntr_Cnt_u08.value)

#  define Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq2Val_HwNm_f32(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq2Val_HwNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq2Val_HwNm_f32() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2.Rte_HwTq2Val_HwNm_f32.value)
