...
#  define Rte_IRead_SignlCondn_Per1_SrlComVehSpeed_Kph_f32() \
  (Rte_Task_2ms_11.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlComVehSpeed_Kph_f32.value)

#  define Rte_IRead_SignlCondn_Per1_SrlCom_VehicleLonAccel_KphpS_f32() \
  (Rte_Task_2ms_11.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlCom_VehicleLonAccel_KphpS_f32.value)

#  define Rte_IWrite_SignlCondn_Per1_VehicleSpeed_Kph_f32(data) \
  ( \
    Rte_Task_2ms_11.Rte_TB.Rte_I_SignlCondn_VehicleSpeed_Kph_f32.value = (data) \
  )
...
#  define Rte_IWrite_SignlCondn_Per1_Vehicle_LonAccel_KphpS_f32(data) \
  ( \
    Rte_Task_2ms_11.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_Vehicle_LonAccel_KphpS_f32.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_Vehicle_LonAccel_KphpS_f32() \
  (&Rte_Task_2ms_11.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_Vehicle_LonAccel_KphpS_f32.value)
