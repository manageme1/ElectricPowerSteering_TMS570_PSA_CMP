 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_Damping.h
...
#  define Rte_InitValue_DefeatDampingSvc_Cnt_lgc (FALSE)
...
#  define Rte_IRead_Damping_Per1_CustomDamp_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_CustomDamp_MtrNm_f32.value)

#  define Rte_IRead_Damping_Per1_DampingDDFactor_Uls_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_DampingDDFactor_Uls_f32.value)

#  define Rte_IRead_Damping_Per1_DefeatDampingSvc_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_DefeatDampingSvc_Cnt_lgc.value)
...
#  define Rte_IWrite_Damping_Per1_DampingCmd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Damping_DampingCmd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_Damping_Per1_DampingCmd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Damping_DampingCmd_MtrNm_f32.value)
