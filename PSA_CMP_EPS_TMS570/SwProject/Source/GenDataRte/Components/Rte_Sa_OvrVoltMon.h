 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Sa_OvrVoltMon.h
...
#  define Rte_IRead_OvrVoltMon_Per1_PwrDiscBTestStart_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_OvrVoltMon_OvrVoltMon_Per1.Rte_PwrDiscBTestStart_Cnt_lgc.value)
...
#  define Rte_Call_phyOvrVoltFdbk_OP_GET IoHwAb_GetOvrVoltFdbk
