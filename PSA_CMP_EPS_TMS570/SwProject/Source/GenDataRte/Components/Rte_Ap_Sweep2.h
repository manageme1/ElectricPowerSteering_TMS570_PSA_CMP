 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_Sweep2.h
...
#  define Rte_InitValue_InputMtrTrq_MtrNm_f32 (0.0F)
#  define Rte_InitValue_OutputMtrTrq_MtrNm_f32 (0.0F)
# endif
...
#  define Rte_IWrite_Sweep2_Per1_OutputMtrTrq_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Sweep2_OutputMtrTrq_MtrNm_f32.value = (data) \
  )
