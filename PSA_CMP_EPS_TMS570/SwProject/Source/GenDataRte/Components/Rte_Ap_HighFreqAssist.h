 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_HighFreqAssist.h
...
#  define Rte_IRead_HighFreqAssist_Per1_WIRCmdAmpBlnd_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_HighFreqAssist_HighFreqAssist_Per1.Rte_WIRCmdAmpBlnd_MtrNm_f32.value)

#  define Rte_IWrite_HighFreqAssist_Per1_HighFreqAssist_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_HighFreqAssist_HighFreqAssist_MtrNm_f32.value = (data) \
  )
