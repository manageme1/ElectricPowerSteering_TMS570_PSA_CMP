...
#  define Rte_IRead_ReturnFirewall_Per1_Defeat_Return_Svc_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_ReturnFirewall_ReturnFirewall_Per1.Rte_Defeat_Return_Svc_Cnt_lgc.value)
...
#  define Rte_IRead_ReturnFirewall_Per1_ReturnCmd_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_ReturnFirewall_ReturnFirewall_Per1.Rte_ReturnCmd_MtrNm_f32.value)
...
#  define Rte_IWrite_ReturnFirewall_Per1_LimitedReturn_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_ReturnFirewall_LimitedReturn_MtrNm_f32.value = (data) \
  )
