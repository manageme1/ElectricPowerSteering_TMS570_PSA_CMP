 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_DiagMgr11.h
...
#  define Rte_Read_Ap_DiagMgr11_HwTrq_HwNm_f32(data) (*(data) = Rte_Sweep_OutputHwTrq_HwNm_f32, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_IgnCnt_Cnt_u16 Rte_Read_Ap_DiagMgr11_IgnCnt_Cnt_u16
#  define Rte_Read_Ap_DiagMgr11_IgnCnt_Cnt_u16(data) (*(data) = Rte_CDDInterface9_IgnCnt_Cnt_u16, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MEC_Cnt_enum Rte_Read_Ap_DiagMgr11_MEC_Cnt_enum
#  define Rte_Read_Ap_DiagMgr11_MEC_Cnt_enum(data) (*(data) = Rte_CDDInterface9_MEC_Cnt_enum, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MfgDiagInhibit_Cnt_lgc Rte_Read_Ap_DiagMgr11_MfgDiagInhibit_Cnt_lgc
#  define Rte_Read_Ap_DiagMgr11_MfgDiagInhibit_Cnt_lgc(data) (*(data) = Rte_CDDInterface6_MfgDiagInhibit_Cnt_lgc, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MtrTrq_MtrNm_f32 Rte_Read_Ap_DiagMgr11_MtrTrq_MtrNm_f32
#  define Rte_Read_Ap_DiagMgr11_MtrTrq_MtrNm_f32(data) (*(data) = Rte_TranlDampg_MRFMtrTrqCmd_MtrNm_f32, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_VehSpd_Kph_f32 Rte_Read_Ap_DiagMgr11_VehSpd_Kph_f32
#  define Rte_Read_Ap_DiagMgr11_VehSpd_Kph_f32(data) (*(data) = Rte_SignlCondn_VehicleSpeed_Kph_f32, ((Std_ReturnType)RTE_E_OK))
