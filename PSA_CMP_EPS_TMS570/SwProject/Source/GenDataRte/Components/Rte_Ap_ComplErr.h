...
#  define Rte_IRead_ComplErr_Per1_TorqueCmdCRF_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_ComplErr_ComplErr_Per1.Rte_TorqueCmdCRF_MtrNm_f32.value)

#  define Rte_IWrite_ComplErr_Per1_ComplErr_HwDeg_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_ComplErr_ComplErr_Per1.Rte_ComplErr_HwDeg_f32.value = (data) \
  )

#  define Rte_IWriteRef_ComplErr_Per1_ComplErr_HwDeg_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_ComplErr_ComplErr_Per1.Rte_ComplErr_HwDeg_f32.value)
