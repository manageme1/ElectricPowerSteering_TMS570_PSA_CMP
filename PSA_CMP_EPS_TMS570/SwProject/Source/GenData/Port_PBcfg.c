...
/* NEXTEER MANUAL EDIT FOR EPWM MODULE */
...
FUNC(void, PORT_PBCODE) Port_InitPortRegs0( void ) /* PRQA S 3408 *//* MD_PORT_8.8 */
{
    ...
    PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_2->Mux.GnrlRg_u32, (uint32)(0x04010101u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_2 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
    PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_3->Mux.GnrlRg_u32, (uint32)(0x01040001u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_3 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
    PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_4->Mux.GnrlRg_u32, (uint32)(0x10100104u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_4 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
    PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_5->Mux.GnrlRg_u32, (uint32)(0x01080404u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_5 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
    PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_6->Mux.GnrlRg_u32, (uint32)(0x01010110u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_6 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
    ...
    PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_30->Mux.GnrlRg_u32, (uint32)(0x00000202u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_30 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
	PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_31->Mux.GnrlRg_u32, (uint32)(0x02020101u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_31 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
	PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_35->Mux.GnrlRg_u32, (uint32)(0x00010101u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_35 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
	PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_37->Mux.GnrlRg_u32, (uint32)(0x01010102u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_37 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
	PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_38->Mux.GnrlRg_u32, (uint32)(0x01000001u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_38 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
