 ...
 * --------  -------  --------  ------------------------------------------------------------------------------  -------
 * 06/10/16   1       WH        Initial version based of version 11 of PSA_BMPV
 * 06/22/16   2       WH        Updates for SF99B                                                                EA3#9081     
...
extern VAR(boolean, CDD_DATA_VAR) CDD_ESCOffsCfgSeld_Cnt_G_lgc;
...
extern VAR(boolean, CDD_DATA_VAR) CDD_MotCurrLoaMtgtnEn_Cnt_G_lgc[D_APPCDDBFRSIZE_CNT_U16];
extern VAR(boolean, CDD_DATA_VAR) CDD_IvtrLoaMtgtnEn_Cnt_G_lgc[D_APPCDDBFRSIZE_CNT_U16];
