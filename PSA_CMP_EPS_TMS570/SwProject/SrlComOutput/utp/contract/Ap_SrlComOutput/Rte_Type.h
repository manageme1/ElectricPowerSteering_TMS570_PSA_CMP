...
struct Rte_CDS_Ap_SrlComOutput
{
  /* Data Handles section */
  P2VAR(Rte_DE_PsaApaTranCause_Cnt_enum, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_APAStateTransitionCause_Cnt_enum;
  P2VAR(Rte_DE_PsaApaSt_Cnt_enum, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_APAState_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_AVASelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_AbsltHwPosnLvl1_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_AbsltHwPosnLvl2_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_AbsltHwPosnVld_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_AbsltHwPosn_HwDeg_f32;
  P2VAR(Rte_DE_PsaAgArbnSt_Enum, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_AgArbnStToSerlCom_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_CAVHCSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_CTCFailed_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_CityParkSelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_DefaultHwaSCommExportValue_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_DmdDelestDaVld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_DrvrIntvDetd_Cnt_lgc;
  P2VAR(Rte_DE_PsaEpsStLxa_Cnt_enum, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_EPSStateForLxa_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ESCOffsCfgSeld_Cnt_lgc;
  P2VAR(Rte_DE_PsaTunModSt_Cnt_enum, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ETATDADYN_Cnt_enum;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_EtatMT_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_HandwheelAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_HandwheelPosition_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_HandwheelTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_HandwheelVelocity_HwRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_LXASelected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_LxaTqLimnActv_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_OutputRampMult_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_RampDwnStatusComplete_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_RelHwPosnToSerlCom_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_RelHwPosnVldToSerlCom_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_STTdSelected_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_SrlComHwTrq_HwNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ValidEngineStatus_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_VehicleSpeed_Kph_f32;
  /* PIM Handles section */
  P2VAR(IS_DAT_DIRA_Msg, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PimIsDatDiraMsg;
  P2VAR(IS_DYN_DAE_Msg, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PimIsDynDaeMsg;
  P2VAR(IS_DYN_VOL_MsgAdd, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PimIsDynVolAddMsg;
  P2VAR(IS_DYN_VOL_MsgBase, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PimIsDynVolBaseMsg;
  P2VAR(IS_SUPV_DIRA_Msg, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PimIsSupvDiraMsg;
...
#    error "The magic number of the generated file <C:/Components/PSA_CMP/PSA_CMP_EPS_TMS570/SwProject/SrlComOutput/utp/contract/Ap_SrlComOutput/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
