...
#   error "The magic number of the generated file <C:/_Synergy_Projects/Working/CmMtrCurr-nz63rn - Copy/CmMtrCurr/utp/contract/Sa_CmMtrCurr/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
