...
# define MtrCurrOffProcessFlag_LowerLimit ((MtrCurrOffProcessFlag)0u)
# define MtrCurrOffProcessFlag_UpperLimit ((MtrCurrOffProcessFlag)4u)
...
#  define CURROFF_INIT ((MtrCurrOffProcessFlag)0u)
# endif
...
#  define CURROFF_PROCESSING ((MtrCurrOffProcessFlag)1u)
# endif
...
#  define CURROFF_PASS ((MtrCurrOffProcessFlag)2u)
# endif
...
#  define CURROFF_FAIL ((MtrCurrOffProcessFlag)3u)
# endif
...
struct Rte_CDS_Sa_CmMtrCurr
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per1_FiltCntrlTemp_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per1_MtrCurr1TempOffset_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per1_MtrCurr2TempOffset_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per2_ADCMtrCurr1_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per2_ADCMtrCurr2_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per2_CorrMtrCurrPosition_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per2_MtrCurrAngle_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per2_MtrCurrK1_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per2_MtrCurrK2_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per3_ADCMtrCurr1_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per3_ADCMtrCurr2_Volts_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per3_ComOffset_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per3_MtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per3_SrlComSvcDft_Cnt_b32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per3_Vecu_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per3_VehSpd_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CMMTRCURR_APPL_VAR) CmMtrCurr_Per3_VhSpdValid_Cnt_lgc;
  /* PIM Handles section */
  P2VAR(CurrTempOffsetType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_CurrTempOffset;
  P2VAR(PhaseCurrCal_DataType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_ShCurrCal;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_CmMtrCurr, RTE_CONST, RTE_CONST) Rte_Inst_Sa_CmMtrCurr;
...
#    error "The magic number of the generated file <C:/_Synergy_Projects/Working/CmMtrCurr-nz63rn - Copy/CmMtrCurr/utp/contract/Sa_CmMtrCurr/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
