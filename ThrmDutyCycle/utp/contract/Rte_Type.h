...
#  if (!defined RTE_CONST_D_100MS_SEC_F32) || (RTE_CONST_D_100MS_SEC_F32 != 0.1)
#   error "Constant value <D_100MS_SEC_F32> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_D_100MS_SEC_F32 (0.1)
#  define D_100MS_SEC_F32 ((Float)0.1)
# endif
...
struct Rte_CDS_Ap_ThrmlDutyCycle
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Init1_DefeatDutySvc_Cnt_lgc;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Init1_IgnTimeOff_Cnt_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Init1_VehTimeValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_CuTempEst_DegC_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_DefeatDutySvc_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_DutyCycleLevel_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_FiltMeasTemp_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_FilteredPkCurr_AmpSq_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_IgnTimeOff_Cnt_u32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_MagTempEst_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_MotorVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_MtrPkCurr_AmpSq_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_SiTempEst_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_ThermLimitPerc_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_ThermalLimit_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_THRMLDUTYCYCLE_APPL_VAR) ThrmlDutyCycle_Per1_VehTimeValid_Cnt_lgc;
  /* PIM Handles section */
  P2VAR(ThrmlDutyCycle_FltStVal_Datatype, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_ThrmlDutyCycle_FltStVal;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_ThrmlDutyCycle, RTE_CONST, RTE_CONST) Rte_Inst_Ap_ThrmlDutyCycle;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy_EA3/Core_Component/Working/ThrmDutyCycle/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
