...
#    error "The magic number of the generated file <C:/Synergy_projects/SgnlCond-lz4p8n/SgnlCond/utp/contract/Ap_SignlCondn/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
