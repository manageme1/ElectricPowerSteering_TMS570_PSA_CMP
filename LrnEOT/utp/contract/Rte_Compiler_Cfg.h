...
#    error "The magic number of the generated file <C:/SynergyWorkspace/WorkingProjects/LrnEOT-5.3/LrnEOT/utp/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
