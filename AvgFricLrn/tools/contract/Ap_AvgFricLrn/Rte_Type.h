...
struct Rte_CDS_Ap_AvgFricLrn
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Init1_FricOffset_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_CRFMtrTrq_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_DefeatFricLearning_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_EstFric_HwNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_FricLrnCustEna_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_FricOffset_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_HwAng_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_HwPosAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_HwTrq_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_HwVel_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_LatAcc_MpSecSq_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_SatEstFric_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_Temperature_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_VehSpd_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_VehicleSpeedValid_Cnt_lgc;
  /* PIM Handles section */
  P2VAR(AvgFricLrnType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_AvgFricLrnData;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_AvgFricLrn, RTE_CONST, RTE_CONST) Rte_Inst_Ap_AvgFricLrn;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/AvgFricLrn/tools/contract/Ap_AvgFricLrn/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
