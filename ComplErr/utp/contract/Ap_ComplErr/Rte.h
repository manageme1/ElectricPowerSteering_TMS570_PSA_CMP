...
#    error "The magic number of the generated file <C:/Synergy_projects/ComplErr-lz4p8n/ComplErr/utp/contract/Ap_ComplErr/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
