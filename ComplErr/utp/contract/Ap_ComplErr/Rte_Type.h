...
struct Rte_CDS_Ap_ComplErr
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_COMPLERR_APPL_VAR) ComplErr_Per1_ComplErr_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_COMPLERR_APPL_VAR) ComplErr_Per1_TorqueCmdCRF_MtrNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_ComplErr, RTE_CONST, RTE_CONST) Rte_Inst_Ap_ComplErr;
...
#    error "The magic number of the generated file <C:/Synergy_projects/ComplErr-lz4p8n/ComplErr/utp/contract/Ap_ComplErr/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
