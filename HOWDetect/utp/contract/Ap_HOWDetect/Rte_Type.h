...
struct Rte_CDS_Ap_HOWDetect
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HOWDETECT_APPL_VAR) HOWDetect_Per1_HOWEstimate_Uls_f32;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_HOWDETECT_APPL_VAR) HOWDetect_Per1_HOWState_Cnt_s08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HOWDETECT_APPL_VAR) HOWDetect_Per1_HwTrq_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HOWDETECT_APPL_VAR) HOWDetect_Per1_VehSpd_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_HOWDetect, RTE_CONST, RTE_CONST) Rte_Inst_Ap_HOWDetect;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy/Prep/HOWDetect-1/HOWDetect/utp/contract/Ap_HOWDetect/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
