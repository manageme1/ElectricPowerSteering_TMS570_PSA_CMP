...
#    error "The magic number of the generated file <C:/Rijvi_Synergy/Prep/HOWDetect-1/HOWDetect/utp/contract/Ap_HOWDetect/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
