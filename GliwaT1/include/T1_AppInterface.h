...
#define T1_TraceStartNoSusp(x) ((void)0)
#define T1_TraceStopNoSusp(x) ((void)0)
#define T1_AppInit() ((void)0)
#define T1_AppHandler() ((void)0)
#define T1_AppRxCallback(x) ((void)0)
#define T1_AppBgHandler() ((void)0)
