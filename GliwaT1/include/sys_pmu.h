...
/** @fn void _pmuSetUserEnable_(uint32 enable)
*   @brief Permit or deny access to the PMU in user mode.
*/
void _pmuSetUserEnable_(uint32 enable);
...
/** @fn uint32 _pmuSetEventCount_(uint32 counter, uint32 count)
*   @brief Sets event counter value
*   @param[in] counter - Counter select 0..2
*   @param[in] count - The new value of the counter.
*/
//void _pmuSetEventCount_(uint32 counter, uint32 count);
