...
;-------------------------------------------------------------------------------
; Set the user enable state of the PMU. If argument is 1, allows access in user mode. If argument is 0, disable in user mode.
    .def     _pmuSetUserEnable_
    .asmfunc
...
;-------------------------------------------------------------------------------
; Set Event Counter Count Value

    .def     _pmuSetEventCount_
    .asmfunc
...
_pmuSetEventCount_
        ...
        lsr   r0,  r0, #1
        mcr   p15, #0, r0, c9, c12, #5 ; select counter
        mcr   p15, #0, r1, c9, c13, #2 ; write event counter
        bx    lr
