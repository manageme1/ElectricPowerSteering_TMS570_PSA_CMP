 ...
 * %version:          5 %
 * %derived_by:       nz63rn %
 * %date_modified:    Mon Jan  6 10:20:04 2014 %
 *---------------------------------------------------------------------------------------------------------------------
 * Date      Rev      Author         Change Description                                                        SCR #
 * -------   -------  --------  ---------------------------------------------------------------------------  ----------
 * 07/03/12   1       LN      		Initial Version																5769
 * 07/11/12   2       LN      		General Updates																5769
 * 07/14/12   3       LN      		Added Imprecise Read/Write Error Handling									5769
 * 07/18/12	  4		  LN			Removed Imprecise Read/Write Error Handling									5769
 * 01/06/14	  5       KMC           Changed uDiagCCRM_Init to non-RTE function                                 11158
 */
/**********************************************************************************************************************
...
/*****************************************************************************
 * Name:        uDiagCCRM_Init
 * Description: Co-Processor Compare Mismatch uDiag Initialization
 * Inputs:      None
 * Outputs:     None
 *****************************************************************************/
FUNC(void, CD_UDIAG_APPL_CODE) uDiagCCRM_Init(void)
{
 ...
 /*****************************************************************************
 * Name:        CCRMErr
 * Description: Co-Processor Compare Mismatch - Interrupt Error Handling
 * Inputs:      None
 * Outputs:     None
 *****************************************************************************/
