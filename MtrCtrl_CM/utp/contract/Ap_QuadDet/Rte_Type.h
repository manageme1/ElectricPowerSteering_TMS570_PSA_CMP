...
struct Rte_CDS_Ap_QuadDet
{
  /* Data Handles section */
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_QUADDET_APPL_VAR) QuadDet_Per1_InstMtrDir_Cnt_s08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_QUADDET_APPL_VAR) QuadDet_Per1_MRFCumMtrPos_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_QUADDET_APPL_VAR) QuadDet_Per1_MRFMtrTrqCmdScl_MtrNm_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_QUADDET_APPL_VAR) QuadDet_Per1_MtrQuad_Cnt_u08;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_QuadDet, RTE_CONST, RTE_CONST) Rte_Inst_Ap_QuadDet;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy_EA3/Core_Component/Working/MtrCtrl_CM/utp/contract/Ap_QuadDet/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
