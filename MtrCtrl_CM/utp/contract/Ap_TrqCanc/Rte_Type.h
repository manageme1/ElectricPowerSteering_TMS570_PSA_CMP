...
struct Rte_CDS_Ap_TrqCanc
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQCANC_APPL_VAR) TrqCanc_Init_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQCANC_APPL_VAR) TrqCanc_Per1_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQCANC_APPL_VAR) TrqCanc_Per1_EstLd_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQCANC_APPL_VAR) TrqCanc_Per1_EstLq_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQCANC_APPL_VAR) TrqCanc_Per1_MRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQCANC_APPL_VAR) TrqCanc_Per1_MtrCurrDaxRef_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQCANC_APPL_VAR) TrqCanc_Per1_MtrCurrQaxRef_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQCANC_APPL_VAR) TrqCanc_Per1_MtrTrqCmdMRFScl_MtrNm_f32;
  /* PIM Handles section */
  P2VAR(CoggingCancTrq, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_CogTrqCal;
  P2VAR(CoggingCancTrqRplComp, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_CogTrqRplComp;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_TrqCanc, RTE_CONST, RTE_CONST) Rte_Inst_Ap_TrqCanc;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy_EA3/Core_Component/Working/MtrCtrl_CM/utp/contract/Ap_TrqCanc/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
