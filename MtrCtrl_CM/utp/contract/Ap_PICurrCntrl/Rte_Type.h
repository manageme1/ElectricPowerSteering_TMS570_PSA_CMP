...
extern CONSTP2CONST(struct Rte_CDS_Ap_PICurrCntrl, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PICurrCntrl;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy_EA3/Core_Component/Working/MtrCtrl_CM/utp/contract/Ap_PICurrCntrl/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
