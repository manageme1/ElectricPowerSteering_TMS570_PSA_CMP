...
struct Rte_CDS_Ap_CurrCmd
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_CurrentGainSvc_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_DualEcuMotCtrlMtgnEna_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_EstLd_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_EstLq_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_EstR_Ohm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_IvtrLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MRFTrqCmdScl_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MotCurrLoaMtgtnEn_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrCurrAngle_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrCurrDaxRef_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrCurrQaxRef_Amp_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrQuad_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrVoltDaxFFStatic_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrVoltQaxFFStatic_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_Vecu_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_VehSpd_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_CurrCmd, RTE_CONST, RTE_CONST) Rte_Inst_Ap_CurrCmd;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy_EA3/Core_Component/Working/MtrCtrl_CM/utp/contract/Ap_CurrCmd/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
