...
struct Rte_CDS_Sa_MtrVel
{
  /* Data Handles section */
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_AsstAssemblyPolarity_Cnt_s08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_HandwheelVel_HwRadpS_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_MechMtrPos2Timestamp_USec_u32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_MechMtrPos2_Rev_u0p16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_MotorVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_MotorVelMRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_SysCHandwheelVel_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_SysCMotorVelMRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per2_HwVelValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per2_SysCDiagHwVel_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per2_SysCDiagMtrVelMRF_MtrRadpS_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_MtrVel, RTE_CONST, RTE_CONST) Rte_Inst_Sa_MtrVel;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrVel_Digi-nzt9hv1/MtrVel_Digi/utp/contract/Sa_MtrVel/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
