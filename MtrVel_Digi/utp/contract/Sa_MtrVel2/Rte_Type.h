...
struct Rte_CDS_Sa_MtrVel2
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL2_APPL_VAR) MtrVel2_Init_CumMechMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_MTRVEL2_APPL_VAR) MtrVel2_Per1_AsstAssemblyPolarity_Cnt_s08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL2_APPL_VAR) MtrVel2_Per1_CumMechMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_MTRVEL2_APPL_VAR) MtrVel2_Per1_MechMtrPos1Timestamp_USec_u32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL2_APPL_VAR) MtrVel2_Per1_SysCDiagHwVel_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL2_APPL_VAR) MtrVel2_Per1_SysCDiagMtrVelMRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL2_APPL_VAR) MtrVel2_Per2_HandwheelVel_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL2_APPL_VAR) MtrVel2_Per2_MotorVelMRF_MtrRadpS_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_MtrVel2, RTE_CONST, RTE_CONST) Rte_Inst_Sa_MtrVel2;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrVel_Digi-nzt9hv1/MtrVel_Digi/utp/contract/Sa_MtrVel2/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
