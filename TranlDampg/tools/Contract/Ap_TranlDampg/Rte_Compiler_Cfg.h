...
#    error "The magic number of the generated file <C:/Synergy_KK/working/TranlDampg-nz4qtt/TranlDampg/tools/contract/Ap_TranlDampg/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
