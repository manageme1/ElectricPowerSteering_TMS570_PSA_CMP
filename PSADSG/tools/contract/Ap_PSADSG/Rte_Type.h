...
struct Rte_CDS_Ap_PSADSG
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSADSG_APPL_VAR) PSADSG_Per1_DampingCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSADSG_APPL_VAR) PSADSG_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSADSG_APPL_VAR) PSADSG_Per1_PsaDampgCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSADSG_APPL_VAR) PSADSG_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_PSADSG, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PSADSG;
...
#    error "The magic number of the generated file <C:/Users/nz2999/Documents/Synergy/ccm_wa/ses_dev_ea3/PSADSG-nz2999/PSADSG/tools/contract/Ap_PSADSG/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
