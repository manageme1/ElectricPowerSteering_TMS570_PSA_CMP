...
struct Rte_CDS_Ap_TqRsDg
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_CorrMtrPosElec_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_EstR_Ohm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_MRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_MtrCurrDaxRef_Amp_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_MtrCurrIdptSig_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_MtrCurrQaxFinalRef_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_MtrVoltDax_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_MtrVoltQax_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_OutputRampMult_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_TrqLimitMin_MtrNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_TqRsDg, RTE_CONST, RTE_CONST) Rte_Inst_Ap_TqRsDg;
...
#    error "The magic number of the generated file <C:/SynergyEA3/Working/TqRsDg/tools/contract/Ap_TqRsDg/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
