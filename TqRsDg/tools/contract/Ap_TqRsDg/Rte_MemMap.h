...
#   error "The magic number of the generated file <C:/SynergyEA3/Working/TqRsDg/tools/contract/Ap_TqRsDg/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
