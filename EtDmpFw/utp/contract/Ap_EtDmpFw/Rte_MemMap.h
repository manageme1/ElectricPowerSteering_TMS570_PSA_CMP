...
#   error "The magic number of the generated file <C:/Synergy_projects/EtDmpFw-lz4p8n/EtDmpFw/utp/contract/Ap_EtDmpFw/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
