...
#    error "The magic number of the generated file <C:/Synergy_KK/working/LmtCod-nz4qtt/LmtCod/tools/contract/Ap_LmtCod/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
