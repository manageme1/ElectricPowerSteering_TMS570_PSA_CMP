...
struct Rte_CDS_Ap_FrqDepDmpnInrtCmp
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_FRQDEPDMPNINRTCMP_APPL_VAR) FrqDepDmpnInrtCmp_Per1_BaseAssistCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_FRQDEPDMPNINRTCMP_APPL_VAR) FrqDepDmpnInrtCmp_Per1_CRFMotorVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_FRQDEPDMPNINRTCMP_APPL_VAR) FrqDepDmpnInrtCmp_Per1_FreqDepDmpSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_FRQDEPDMPNINRTCMP_APPL_VAR) FrqDepDmpnInrtCmp_Per1_FrqDepDmpnInrtCmp_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_FRQDEPDMPNINRTCMP_APPL_VAR) FrqDepDmpnInrtCmp_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_FRQDEPDMPNINRTCMP_APPL_VAR) FrqDepDmpnInrtCmp_Per1_VehicleLonAccel_KphpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_FRQDEPDMPNINRTCMP_APPL_VAR) FrqDepDmpnInrtCmp_Per1_VehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_FRQDEPDMPNINRTCMP_APPL_VAR) FrqDepDmpnInrtCmp_Per1_WIRCmdAmpBlnd_MtrNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_FrqDepDmpnInrtCmp, RTE_CONST, RTE_CONST) Rte_Inst_Ap_FrqDepDmpnInrtCmp;
...
#    error "The magic number of the generated file <C:/synergy_projects/FrqDepDmpnInrtCmp/FrqDepDmpnInrtCmp/utp/contract/Ap_FrqDepDmpnInrtCmp/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
