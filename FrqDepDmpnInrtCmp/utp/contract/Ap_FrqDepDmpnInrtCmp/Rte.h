...
#    error "The magic number of the generated file <C:/synergy_projects/FrqDepDmpnInrtCmp/FrqDepDmpnInrtCmp/utp/contract/Ap_FrqDepDmpnInrtCmp/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
