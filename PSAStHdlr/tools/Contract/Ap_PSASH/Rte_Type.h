...
#  define NTC_Num_PLLSlipNrcvrl ((NTCNumber)22u)
# endif
...
#  define NTC_Num_PeripheralStartupFlt ((NTCNumber)55u)
# endif
...
#  define NTC_Num_BattVltgMeasdCorrlnFlt ((NTCNumber)73u)
# endif
...
#  define NTC_Num_IvtrPwrDiscnctFailr ((NTCNumber)74u)
# endif
...
#  define NTC_Num_PowerRelayInit2Flt ((NTCNumber)75u)
# endif
...
#  define NTC_Num_GateDrvFltInProcess ((NTCNumber)76u)
# endif
...
#  define NTC_Num_Ivtr2PwrDiscnctFailr ((NTCNumber)90u)
# endif
...
#  define NTC_Num_SysVltgCorrlnFlt ((NTCNumber)91u)
# endif
...
#  define NTC_Num_Inv2GateDrvFltInProcess ((NTCNumber)92u)
# endif
...
#  define NTC_Num_Inv2GateDrvFlt ((NTCNumber)93u)
# endif
...
#  define NTC_Num_Inv2OnStateSingleFET ((NTCNumber)94u)
# endif
...
#  define NTC_Num_EcuIdnFlt ((NTCNumber)95u)
# endif
...
#  define NTC_Num_IMCLossOfCom ((NTCNumber)125u)
# endif
...
#  define NTC_Num_ImcArbrFault ((NTCNumber)127u)
# endif
...
#  define NTC_Num_TurnCntr_SpiDataFlt ((NTCNumber)135u)
# endif
...
#  define NTC_Num_EcuCrossChk ((NTCNumber)150u)
# endif
...
#  define NTC_Num_ImcSigArbHighOffsetCorrection ((NTCNumber)151u)
# endif
...
#  define NTC_Num_EcuConfigMismatch ((NTCNumber)152u)
# endif
...
#  define NTC_Num_LimpHomeIgnitionCounter ((NTCNumber)161u)
# endif
...
#  define NTC_Num_AgCompDiagc ((NTCNumber)167u)
# endif
...
#  define NTC_Num_LoaRpdShutdn ((NTCNumber)170u)
# endif
...
#  define NTC_Num_LoaCtrldShutdn ((NTCNumber)171u)
# endif
...
#  define NTC_Num_LoaMgr_HwTqIdptSigTooLow ((NTCNumber)172u)
# endif
...
#  define NTC_Num_LoaMgr_MotAgIdptSigTooLow ((NTCNumber)173u)
# endif
...
#  define NTC_Num_LoaMgr_MotCurrIdptSigTooLow ((NTCNumber)174u)
# endif
...
#  define NTC_Num_LoaMgr_IvtrIdptSigTooLow ((NTCNumber)175u)
# endif
...
#  define NTC_Num_DataOtherFlt2Msg_Q ((NTCNumber)327u)
# endif
...
#  define NTC_Num_MissingMsg_AM ((NTCNumber)482u)
# endif
...
#  define NTC_Num_InvalidMsg_AM ((NTCNumber)483u)
# endif
...
#  define NTC_Num_CRCFltMsg_AM ((NTCNumber)484u)
# endif
...
#  define NTC_Num_PgrsCntFltMsg_AM ((NTCNumber)485u)
# endif
...
#  define NTC_Num_DataRngFltMsg_AM ((NTCNumber)486u)
# endif
...
#  define NTC_Num_InvalidMsg_AL ((NTCNumber)488u)
# endif
...
#  define NTC_Num_DataRngFltMsg_AL ((NTCNumber)492u)
# endif
...
#  define NTC_Num_DataOtherFltMsg_AL ((NTCNumber)494u)
# endif
...
#  define NTC_Num_PHAPosnSnsrVsPwrpkDataWrong ((NTCNumber)500u)
# endif
...
#  define NTC_Num_EEPROMtoFeeCpyError ((NTCNumber)500u)
# endif
...
#  define NTC_Num_PHAScratchPadTrf ((NTCNumber)503u)
# endif
...
#  define NTC_Num_AnaHWDiffTqOfstNotTrmd ((NTCNumber)508u)
# endif
...
#  define NTC_Num_SENTHWDiffTqOfstNotTrmd ((NTCNumber)511u)
# endif
...
# define PsaApaSt_Cnt_enum_LowerLimit ((PsaApaSt_Cnt_enum)0u)
# define PsaApaSt_Cnt_enum_UpperLimit ((PsaApaSt_Cnt_enum)3u)
...
#  define PSAAPAST_UNAVL ((PsaApaSt_Cnt_enum)0u)
# endif
...
#  define PSAAPAST_AVL ((PsaApaSt_Cnt_enum)1u)
# endif
...
#  define PSAAPAST_CTRLPRGS ((PsaApaSt_Cnt_enum)2u)
# endif
...
#  define PSAAPAST_DFCT ((PsaApaSt_Cnt_enum)3u)
# endif

# define Rte_TypeDef_PsaApaTranCause_Cnt_enum
typedef uint8 PsaApaTranCause_Cnt_enum;
# define PsaApaTranCause_Cnt_enum_LowerLimit ((PsaApaTranCause_Cnt_enum)0u)
# define PsaApaTranCause_Cnt_enum_UpperLimit ((PsaApaTranCause_Cnt_enum)7u)
...
#  define PSAAPATRANCAUSE_NOINTRPT ((PsaApaTranCause_Cnt_enum)0u)
# endif
...
#  define PSAAPATRANCAUSE_DRVRINTV ((PsaApaTranCause_Cnt_enum)1u)
# endif
...
#  define PSAAPATRANCAUSE_VEHSPDHI ((PsaApaTranCause_Cnt_enum)2u)
# endif
...
#  define PSAAPATRANCAUSE_AGLERR ((PsaApaTranCause_Cnt_enum)3u)
# endif
...
#  define PSAAPATRANCAUSE_MTRSTALL ((PsaApaTranCause_Cnt_enum)4u)
# endif
...
#  define PSAAPATRANCAUSE_UNUSED ((PsaApaTranCause_Cnt_enum)5u)
# endif
...
#  define PSAAPATRANCAUSE_THERMLIM ((PsaApaTranCause_Cnt_enum)6u)
# endif
...
#  define PSAAPATRANCAUSE_OTHERERR ((PsaApaTranCause_Cnt_enum)7u)
# endif

# define Rte_TypeDef_PsaEpsStLxa_Cnt_enum
typedef uint8 PsaEpsStLxa_Cnt_enum;
# define PsaEpsStLxa_Cnt_enum_LowerLimit ((PsaEpsStLxa_Cnt_enum)0u)
# define PsaEpsStLxa_Cnt_enum_UpperLimit ((PsaEpsStLxa_Cnt_enum)4u)
...
#  define PSAEPSSTLXA_UNAUTHD ((PsaEpsStLxa_Cnt_enum)0u)
# endif
...
#  define PSAEPSSTLXA_AUTHD ((PsaEpsStLxa_Cnt_enum)1u)
# endif
...
#  define PSAEPSSTLXA_AVL ((PsaEpsStLxa_Cnt_enum)2u)
# endif
...
#  define PSAEPSSTLXA_ACTV ((PsaEpsStLxa_Cnt_enum)3u)
# endif
...
#  define PSAEPSSTLXA_DFCT ((PsaEpsStLxa_Cnt_enum)4u)
# endif

# define Rte_TypeDef_PsaLxaSt_Cnt_enum
typedef uint8 PsaLxaSt_Cnt_enum;
# define PsaLxaSt_Cnt_enum_LowerLimit ((PsaLxaSt_Cnt_enum)0u)
# define PsaLxaSt_Cnt_enum_UpperLimit ((PsaLxaSt_Cnt_enum)6u)
...
#  define PSALXAST_UNAVL ((PsaLxaSt_Cnt_enum)0u)
# endif
...
#  define PSALXAST_UNSELD ((PsaLxaSt_Cnt_enum)1u)
# endif
...
#  define PSALXAST_SELD ((PsaLxaSt_Cnt_enum)2u)
# endif
...
#  define PSALXAST_AUTHD ((PsaLxaSt_Cnt_enum)3u)
# endif
...
#  define PSALXAST_ACTV ((PsaLxaSt_Cnt_enum)4u)
# endif
...
#  define PSALXAST_DFCT ((PsaLxaSt_Cnt_enum)5u)
# endif
...
#  define PSALXAST_COLLRISK ((PsaLxaSt_Cnt_enum)6u)
# endif
...
#  define PsaEpsSt_Cnt_enum_LowerLimit ((PsaEpsSt_Cnt_enum)0u)
#  define PsaEpsSt_Cnt_enum_UpperLimit ((PsaEpsSt_Cnt_enum)2u)
...
#   define PSAEPSST_UNAVL ((PsaEpsSt_Cnt_enum)0u)
#  endif
...
#   define PSAEPSST_AVL ((PsaEpsSt_Cnt_enum)1u)
#  endif
...
#   define PSAEPSST_DFCT ((PsaEpsSt_Cnt_enum)2u)
#  endif
...
#  define D_PSAAPASTINIT_CNT_ENUM ((PsaApaSt_Cnt_enum)0u)
# endif
...
#  define D_PSAAPATRANCAUSEINIT_CNT_ENUM ((PsaApaTranCause_Cnt_enum)0u)
# endif
...
#  define D_PSAEPSSTLXAINIT_CNT_ENUM ((PsaEpsStLxa_Cnt_enum)0u)
# endif
...
#  define D_PSALXASTINIT_CNT_ENUM ((PsaLxaSt_Cnt_enum)0u)
# endif
...
struct Rte_CDS_Ap_PSASH
{
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_AbsActv_Cnt_lgc;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_ApaHwAgCmd_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_ApaPosSrvoFlt_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_ApaRelaxReq_Cnt_lgc;
  P2VAR(Rte_DE_PsaApaTranCause_Cnt_enum, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_ApaStateTransitionCause_Cnt_enum;
  P2VAR(Rte_DE_PsaApaSt_Cnt_enum, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_ApaState_Cnt_enum;
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_DrvrIntvDetd_Cnt_lgc;
  P2VAR(Rte_DE_PsaEpsStLxa_Cnt_enum, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_EPSStateForLxa_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_EscActv_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_EscEna_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_EscFltPrsnt_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_FTermActv_Cnt_lgc;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_HOWState_Cnt_s08;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_HandwheelVelocity_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_HwTrqRate_HwNmpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LpaSeld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaApaConflictReqNTC_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaCorrnFacReqLimd_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaDrvrAbsntDetd_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaDrvrAbsntHwVelDetd_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaDrvrAbsntWarn_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaHwAgCmd_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaHwAgDetd_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaInactivOnDrvrBhvr_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaInpVld_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaSelected_Cnt_lgc;
  P2VAR(Rte_DE_PsaLxaSt_Cnt_enum, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaState_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PSASH_APPL_VAR) PSASH_Per1_LxaTqFacReq_Uls_f32;
...
#    error "The magic number of the generated file <C:/Users/nz2999/Documents/Synergy/ccm_wa/ses_dev_ea3/PSAStHdlr-nz2999/PSAStHdlr/tools/contract/Ap_PSASH/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
