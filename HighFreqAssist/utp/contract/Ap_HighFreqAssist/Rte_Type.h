...
struct Rte_CDS_Ap_HighFreqAssist
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HIGHFREQASSIST_APPL_VAR) HighFreqAssist_Per1_HighFreqAssist_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HIGHFREQASSIST_APPL_VAR) HighFreqAssist_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HIGHFREQASSIST_APPL_VAR) HighFreqAssist_Per1_VehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HIGHFREQASSIST_APPL_VAR) HighFreqAssist_Per1_WIRCmdAmpBlnd_MtrNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_HighFreqAssist, RTE_CONST, RTE_CONST) Rte_Inst_Ap_HighFreqAssist;
...
#    error "The magic number of the generated file <C:/Workspace/HighFreqAssist-CBD_HighFreqAssist/SF28/HighFreqAssist/utp/contract/Ap_HighFreqAssist/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
