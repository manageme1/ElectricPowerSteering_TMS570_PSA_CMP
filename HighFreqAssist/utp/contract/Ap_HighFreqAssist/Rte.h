...
#    error "The magic number of the generated file <C:/Workspace/HighFreqAssist-CBD_HighFreqAssist/SF28/HighFreqAssist/utp/contract/Ap_HighFreqAssist/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
